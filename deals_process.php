...
if (file_exists("../img/" . $_FILES["file2"]["name"]))
  ...
  {
  $file_name = getToken(6).$_FILES["file2"]['name']."das";
 ...
 $temp2=$file_name;
    ...
    $subject = "Hi $nickname You have successfully Posted Your Deal $title in Trade My Deals";
    $txt = "http://trademydeals/deals.php";
    ...
    $sql="INSERT INTO `deals`(`user_id`,`deals_title`,`category-name`,`sub-category-id`, `company_name`, `description`, `country`, `state`, `city_deal`, `postalcode_deal`, `city_your`, `postalcode_your`, `websitelink`, `youtube`, `images`, `publish_plan`, `promote_deals`,`promote_deals1`,`promote_deals2`,`promote_deals3`,`promote_deals4`, `promote_high`, `promote_top`, `promote_sider`, `promote_slider`, `promote_home`, `date_time`,`deals_images`,`exp_date`,`share_phone`,`share_email`) VALUES  ('$user_id','$title','$category','$sub_category','$company','$description','$country','$state','$city_ads','$postal_ads','$city_your','$postal_your','$website','$youtube','$temp1','$text','$promote_ads','$promote_ads1','$promote_ads2','$promote_ads3','$promote_ads4','$promote_high','$promote_top','$promote_sider','$promote_slider','$promote_home', now(),'$temp2','$exp_date','$share_phone','$share_email')";
    //echo $sql;
    //$sql11=mysql_query($sql) or die("Invalid Query: ".mysql_error());
    $sql11=mysql_query($sql);
	$insert_id = mysql_insert_id();
	UploadImages($insert_id,'deals');
	header("Location: getdeals.php?id=$insert_id");
	exit;
?>