...
<?php 
  ...
  <form action="paypal2/paypal1.php" method="post" enctype="multipart/form-data" name="listForm" >
<?php
}
?>
    <div class="content">
                                ...
                                <div class="col-lg-7">
                                      <input name="title" type="text" class="form-control">
                                       <input name="user_id" type="hidden" value="<?php echo $user_id; ?>">
                                        <input name="product" type="hidden" value="<?php echo "coupons"; ?>">
                      ...
                      <br><input type="hidden" value="<?php echo $user_id; ?>" id="user_id" />
                        ...
                        <div class="deals_form">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="col-lg-5">
                                <p style="background:#f79e12; padding:5px; margin-left:-20px; margin-top:5px;">Hightlighted Coupon</p>
                                </div>
...
if ($static['status']=='Pro Membership' )
                         ...
                         { }
                             ...
                             <div class="col-lg-12">
                                ...
                                <div class="col-lg-5">
                                <p style="background:#f79e12; padding:5px; margin-left:-20px; margin-top:5px;">Top Coupons</p>
                                </div>
...
if ($static['status']=='Pro Membership' )
                         ...
                         { }
                           ...
                           <div class="col-lg-12">
                                ...
                                <div class="col-lg-5">
                                <p style="background:#f79e12; padding:5px; margin-left:-20px; margin-top:5px;">Home page Gallery Coupons</p>
                                </div>
...
if ($static['status']=='Pro Membership' )
                         ...
                         { }
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="col-lg-5">
                                <p style="background:#f79e12; padding:5px; margin-left:-20px;margin-top:5px;">Top Feature Home page slider Coupons</p>
                                </div>
                                <div class="col-lg-6"></div>
                            </div> 
...
if ($static['status']=='Pro Membership' )
                 ...
                 <div class="col-lg-12">
                  <p  style="margin-left:30px; margin-top:30px;"> by posting this Coupon,you are agreeing with our terms and conditions</p>                    <?php 
if ($static['status']=='Pro Membership' OR $static['status']=='Gold Membership') { } else {?> <p>Total:&nbsp;$ <input type="text" name="total" value="0" style="border:none; background:#e2e2e2;"> </p><?php } ?>
                  <input type="submit" class="btn btn btn-primary pull-right btn6" value="Post Your Deals">  
                 </div>
                </div>
                 </form>
             <?php 
