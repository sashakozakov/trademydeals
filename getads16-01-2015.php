    	...
    	<div class="container">
        	<div class="col-lg-12">
                	...
                	<div class="col-lg-9 ads">
                        ...
                        <a href="#"><button type="button" class="btn getbtn1 btn-danger pull-right">Get the Details</button></a></h4>
                        ...
                        <div class="col-lg-6"><br>
                            <p style="margin-left:30px;"><span class="glyphicon glyphicon-globe" style="margin-right:10px;"></span>Website:&nbsp;<a href="<?php echo 'http://'.$single['websitelink'];?>"><?php echo $single['websitelink']; ?></a></p>
...
alert("Gireesh");
  $('.slider1').bxSlider({
    ...
    slideMargin: 10
                   ...
                   $top_query=mysql_query("SELECT * FROM `ads` ORDER BY id DESC LIMIT 3");     
                   ...
                   ?>
                    	 <div class="col-lg-4">
                            <div class="content2" style="margin-top:10px;">
                                       ...
                                       <a href="getads.php?id=<?php echo $top['id']; ?>"><h3><?php echo $top['ads_title']; ?></h3>
