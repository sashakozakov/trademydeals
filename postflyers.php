                  ...
                  <div class="deals_content">
                      <br>
                        ...
                        <div class="deals_form">
                            ...
                            <div class="col-lg-12">
                                <div class="col-lg-1">
                                    <input type="checkbox" class=" click1" name="website" value="5"  id="website">
                                </div>
                                <div class="col-lg-4">
                  ...
                  <div class="deals_content">
                      <br><input type="hidden" value="<?php echo $user_id; ?>" id="user_id" />
                        ...
                        <div class="deals_form">
                            ...
                            <div class="col-lg-12">
                                <div class="col-lg-1">
                                    <input type="checkbox" class="click2" name="highlight" value="high" onClick="subtotal()">
                                </div>
                                <div class="col-lg-5">
...
if ($static['status']=='Pro Membership' )
                         ...
                         { }
                             ...
                             <div class="col-lg-12">
                                <div class="col-lg-1">
                                    <input type="checkbox" class=" click3" name="promote_ads1" value="top"onClick="subtotalnew()">
                                </div>
                                <div class="col-lg-5">
...
if ($static['status']=='Pro Membership' )
                         ...
                         { }
                           ...
                           <div class="col-lg-12">
                                <div class="col-lg-1">
                                    <input type="checkbox" class=" click4" name="promote_ads2" value="home" onClick="subtotalnew1()">
                                </div>
                                <div class="col-lg-5">
...
if ($static['status']=='Pro Membership' )
                         ...
                         { }
                             ...
                             <div class="col-lg-12">
                                <div class="col-lg-1">
      <input type="checkbox" class=" click5" name="promote_ads3" value="sidebar" onClick="subtotalnew2()">
                                </div>
                                <div class="col-lg-5">
...
if ($static['status']=='Pro Membership' )
                         ...
                         { }
                            ...
                            <div class="col-lg-12">
                                <div class="col-lg-1">
                                    <input type="checkbox" class=" click6" name="promote_ads4" value="slider" onClick="subtotalnew3()">
                                </div>
                                <div class="col-lg-5">
...
if ($static['status']=='Pro Membership' OR $static['status']=='Gold Membership') {
                                ...
                                <div class="col-lg-1">
                                    <input class="abc" type="radio" name="sliderdeals" value="20" onClick="subtotalnew3()" checked > 
                                </div>
                                <div class="col-lg-3">
...
if ($static['status']=='Pro Membership' )
                         ...
                         { }
                              ...
                              <div class="col-lg-4" style="border:#fff solid 1px;">
                               ...
                               <div class="col-lg-12">
                                <div class="col-lg-1">
                                    <input type="checkbox" class="click10" name="promote10" value="urgent1" onClick="subtotal10()">
                                </div>
                                <div class="col-lg-5">
                                <p style="background:#f79e12; padding:5px; margin-left:-20px;margin-top:5px;">Urgent Ad</p>
                                </div>
...
if ($static['status']=='Pro Membership' OR $static['status']=='Gold Membership') { } else {?> <p class="pull-right"><span style="font-weight:bold;font-family:arial;font-size:18px;">Total Price:</span>:&nbsp;$ <input type="text" name="total" value="0" style="border:none; background:#e2e2e2;"> </p><?php } ?>
				 ...
				 <div class="col-lg-12">
				    ...
				    <input type="submit" class="btn btn btn-primary pull-right btn6" value="Post My Flyer">
				 </div>
                </div>
                 </form>
             <?php 
