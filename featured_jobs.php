                ...
                <div class="col-lg-9">
                    ...
                    <div class="col-lg-12" style="display:<?php echo $none_all_ads;?>;">
                        ...
                        <div class="col-lg-12">
                            ...
                            $query = "(SELECT * FROM `jobs` where  (promote_jobs = 'high' or promote_jobs = '') and payment_status = '1' ORDER BY promote_jobs DESC, date_time desc )";
                            ...
                            <div class="col-lg-4">
                                ...
                                <a href="getdeals.php?id=<?php echo $row->id; ?>"><h3><?php echo get_post_tile_string($row->jobs_title); ?></h3>
