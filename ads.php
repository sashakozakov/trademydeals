...
border-bottom-right-radius:10px; margin-left:10px;">Post Ad
            ...
            <div class="col-lg-12">
                <?php $none_all_ads = "block";
                if (isset($_REQUEST['product']) && isset($_REQUEST['id'])) {
                    $none_all_ads = "none"; ?>
                    <div class="sub1" style="background:#FF9933; margin-left:10px;">
                        <h4>Ads -> <a href="#"
                                      style="color:#000000; text-decoration:underline;"><?php echo $_REQUEST['product']; ?></a>
                        </h4>
                ...
                <?php } else { ?>
                    <div class="sub1" style="background:#FF9933; margin-left:10px;">
                        <h4>Top Ads &nbsp;&nbsp;&nbsp;<a href="top-ads.php"
                                                         style="color:#000000; text-decoration:underline;">see all top
                                ads</a></h4>
                ...
                <div class="col-lg-12">
                    <div class="newcontent"><?php if (!isset($_REQUEST['product'])) {
                            $top_query = mysql_query("SELECT * FROM `ads` WHERE `promote_ads1`='top'  and payment_status = '1' and country =  '$country_name' ORDER BY rand() limit 0,6");
                            while ($top = mysql_fetch_array($top_query)) {
                                ?>
                                <div class="col-lg-4">
                                    <div class="content2" style="margin-top:10px;">

                                        <img src="img/<?php echo get_post_image($top['id'], 'ads'); ?>"
                        ...
                        } elseif (isset($_REQUEST['product']) && isset($_REQUEST['id'])) {  //echo "SELECT * FROM `ads` WHERE `sub-category-id`= '".$_REQUEST['id']."' ORDER BY date_time DESC";
                            $top_query = mysql_query("SELECT * FROM `ads` WHERE `sub-category-id`= '" . $_REQUEST['id'] . "'  and payment_status = '1' and country =  '$country_name' ORDER BY date_time DESC");
                            if (mysql_num_rows($top_query)) {
                                    ...
                                    <div class="col-lg-4">
                                        <div class="content2" style="margin-top:10px;">
                                            ...
                                            <a href="getads.php?id=<?php echo $top['id']; ?>">
                                                ...
                                                <p><?php echo substr($top['description'], 0, 15) . '...'; ?></p>
                                                <button type="button" class="btn btn-sm btn-danger pull-right btn5">
                                                    View
                                                </button>
                                            </a></div>
                                    </div> <?php }
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <p style="margin: 20px 46px 10px -0px;">No ads are available here.</p>
                                </div>
                            <?php }
                        } elseif (isset($_REQUEST['product']) && !isset($_REQUEST['id'])) {  //echo "SELECT * FROM `ads` WHERE `category-name`= '".$_REQUEST['product']."' ORDER BY date_time DESC";
                            $top_query = mysql_query("SELECT * FROM `ads` WHERE `category-name`= '" . $_REQUEST['product'] . "' and payment_status = '1' and country =  '$country_name' ORDER BY date_time DESC");
                            if (mysql_num_rows($top_query)) {
                                while ($top = mysql_fetch_array($top_query)) {
                                    ?>
                                    <div class="col-lg-4">
            ...
            <div class="col-lg-12" style="display:<?php echo $none_all_ads; ?>">
                ...
                <div class="col-lg-12">
                    <?php
                    $filename = "ads.php"; // name of this file
                    ...
                    <div class="col-lg-4">
                        ...
                        <?php $imgdeal = $row->images; ?>

                        <img src="img/<?php echo get_post_image($row->id, 'ads'); ?>" class="img-responsive">


                        <a href="getads.php?id=<?php echo $row->id; ?>">
                            <h3><?php echo get_post_tile_string($row->ads_title); ?></h3>
