    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <script type="text/javascript">
                $(document).ready(function() {
                    ...
                    $("#add_more_image").click(function(){
                        price_total = parseFloat($("#total").val());
                        total = parseFloat($("#image_total").val())+1;
            ...
            <form action="" method="post" enctype="multipart/form-data" name="listForm" onsubmit="return checkDeals();" >
                ...
                <input type="hidden" value="<?php echo $_REQUEST['id'];?>" name="post_id" id="post_id" />
                                    ...
                                    <div class="deals_content">
                                        ...
                                        <div class="deals_form">
                                            ...
                                            <div class="col-lg-12" style="margin-top:20px;">
                                                ...
                                                <div class="col-lg-7">
                                                    <input name="company" id="company" value="<?php echo $ads_details['company_name'];?>" type="text" class="form-control">
                                                </div>
                                                <div class="col-lg-2">
                                                </div>
                                            </div>
                                    ...
                                    function unlink_file(file_name,counter_value){
                                        ...
                                        $.ajax({
                                            ...
                                            success:function(data){
                                                ...
                                                if(total_images>5)
                                                {
                                                    var price_total = parseFloat($("#total").val());
                                                    $("#total").val(price_total-1);
                                        ...
                                        j('#fileupload').fileupload({
                                            ...
                                            dataType: 'json',
                                                ...
                                                j.each(data.result.files, function (index, file) {
                                                    ...
                                                    if(counter>5)
                                                    {
                                                        var price_total = parseFloat(j("#total").val());
                                ...
                                <div class="col-lg-12">
                                    <div class="deals_content">
                                        ...
                                        <div class="deals_form">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="col-lg-1">
                                                    <input id="chk1" <?php if($ads_details['promote_ads']) echo 'checked=checked';?> type="checkbox" class="click2" name="highlight" value="high"  onClick="subtotal()" >
                                                </div>
                                                <div class="col-lg-5">
                                            ...
                                            <div class="deals_work2">
                                                <div class="col-lg-12">
                                                    ...
                                                    if ($static['status']=='Pro Membership' OR $static['status']=='Gold Membership')
                                                    {
                                                        ...
                                                        <div class="col-lg-1">
                                                            <p style="margin-left:20px;"><input type="text" name="output" value="3" style="border:none; background:#e2e2e2; "></p>
                                                        </div>
                            ...
                            <div class="col-lg-12"> <?php
                              ...
                              <div class="col-lg-4" style="border:#fff solid 1px;">
                                ...
                                <div class="col-lg-1">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="col-lg-1">
                                                    <input  id="chk2" <?php if($ads_details['promote_ads1']) echo 'checked=checked';?> type="checkbox" class=" click3" name="promote_ads1" value="top" onClick="subtotalnew()">
                                                </div>
                                                <div class="col-lg-5">
                            ...
                            <div class="col-lg-12"> <?php
                              ...
                              <div class="col-lg-4" style="border:#fff solid 1px;">
                                ...
                                <div class="col-lg-1">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="col-lg-1">
                                                    <input  id="chk3" <?php if($ads_details['promote_ads2']) echo 'checked=checked';?> type="checkbox" class=" click4" name="promote_ads2" value="home" onClick="subtotalnew1()">
                                                </div>
                                                <div class="col-lg-5">
                            ...
                            <div class="col-lg-12"> <?php
                              ...
                              <div class="col-lg-4" style="border:#fff solid 1px;">
                                ...
                                <div class="col-lg-1">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="col-lg-1">
                                                    <input  id="chk4" <?php if($ads_details['promote_ads3']) echo 'checked=checked';?> type="checkbox" class=" click5" name="promote_ads3" value="sidebar" onClick="subtotalnew2()">
                                                </div>
                                                <div class="col-lg-5">
                            ...
                            <div class="col-lg-12"> <?php
                              ...
                              <div class="col-lg-4" style="border:#fff solid 1px;">
                                ...
                                <div class="col-lg-1">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="col-lg-1">
                                                    <input id="chk5" <?php if($ads_details['promote_ads4']) echo 'checked=checked';?> type="checkbox" class=" click6" name="promote_ads4" value="slider" onclick=" subtotalnew3();">
                                                </div>
                                                <div class="col-lg-5">
                            ...
                            <div class="col-lg-12"> <?php
                              ...
                              <div class="col-lg-4" style="border:#fff solid 1px;">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <input type="submit" name="update_post" class="btn btn btn-primary pull-left btn6" value="Update Ads" >
                                </div>
                            </div>
            </form>
