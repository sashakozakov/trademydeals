                        ...
                        <div class="col-lg-12">
                            <div class="col-lg-9">
                                <div class="col-lg-3">
                                    ...
                                    <p><a href="mydeals.php"><button type="button" class="btn btn-lg btn-success btn2" id="mydeals" style="margin-top:3px">My Deals</button></a></p>
                                    ...
                                    <div class="deals_content">
                                        ...
                                        <div class="deals_form">
                                            ...
                                            <div class="col-lg-12" style="margin-top:20px;">
                                                ...
                                                <div class="col-lg-7">
                                                    <input class="form-control" name="expire" type="text" value="<?php echo $ads_details['exp_date'];?>"  id="datepicker">
                                                </div>
                                                <div class="col-lg-2">
                                                </div>
                                            </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="deals_content">
                                        ...
                                        <div class="deals_form">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="col-lg-1">
                                                    <input  type="checkbox" id="chk1" <?php if($ads_details['promote_deals']!=""){echo "checked='checked'";}?> class="click2" name="highlight" value="high" onclick="subtotal();">
                                                </div>

                                                <div class="col-lg-5">
                                                    <p onclick="$('.click2').click()" style="background:#f79e12; padding:5px; margin-left:-20px; margin-top:5px;">Hightlighted Deal</p>
                                                </div>
                                                ...
                                                <div class="col-lg-12">
                                                    ...
                                                    if ($static['status']=='Pro Membership' OR $static['status']=='Gold Membership')
                                                    {
                                                        ...
                                                        <div class="col-lg-2">
                                                            ...
                                                            <select name="select1" id="select1" style="width:100px;"onchange="subtotal();">
                                                        ...
                                                        <div class="col-lg-1">
                                                            <p><input type="text" name="output" value="3" style="border:0px none; background:#e2e2e2;"></p>
                                                        </div>
                                ...
                                <div class="col-lg-1">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="col-lg-1">
                                                    ...
                                                    <input type="checkbox" id="chk2" <?php if($ads_details['promote_deals1']!=""){echo "checked='checked'";}?> class=" click3" name="promote_ads1" value="top" onclick="subtotalnew();">
                                                </div>
                                                <div class="col-lg-5">
                                                    <p onclick="$('.click3').click()" style="background:#f79e12; padding:5px; margin-left:-20px; margin-top:5px;">Top Deal</p>
                                                </div>
                                            ...
                                            <div class="deals_work3">
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="col-lg-2">
                                                        <select name="select2" style="width:100px;" onchange="subtotalnew()">
                            ...
                            <div class="col-lg-12"> <?php
                              ...
                              <div class="col-lg-4" style="border:#fff solid 1px;">
                                ...
                                <div class="col-lg-1">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="col-lg-1">
                                                    <input type="checkbox" id="chk3" <?php if($ads_details['promote_deals2']!=""){echo "checked='checked'";}?> class=" click4" name="promote_ads2" value="home" onclick="subtotalnew1();">
                                                </div>
                                                <div class="col-lg-5">
                                                    <p onclick="$('.click4').click()" style="background:#f79e12; padding:5px; margin-left:-20px; margin-top:5px;">Home page Gallery Deal</p>
                                                </div>
              ...
              <div class="deals_work9">
                            ...
                            <div class="col-lg-12"> <?php
							  ...
							  -->
                                            ...
                                            <div class="col-lg-12">
                                                <div class="col-lg-1">
                                                    <input type="checkbox" id="chk4" <?php if($ads_details['promote_deals3']!=""){echo "checked='checked'";}?> class="click5" name="promote_ads3" value="sidebar" onclick="subtotalnew2();">
                                                </div>
                                                <div class="col-lg-5">
                                                    <p onclick="$('.click5').click()" style="background:#f79e12; padding:5px; margin-left:-20px;margin-top:5px;">Sidebar Deal</p>
                                                </div>
                            ...
                            <div class="col-lg-12"> <?php
                              ...
                              <div class="col-lg-4" style="border:#fff solid 1px;">
                                ...
                                <div class="col-lg-1">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="col-lg-1">
                                                    <input type="checkbox" id="chk5" <?php if($ads_details['promote_deals4']!=""){echo "checked='checked'";}?> class=" click6" name="promote_ads4" value="slider" onclick="subtotalnew3();">
                                                </div>
                                                <div class="col-lg-5">
                                                    <p onclick="$('.click6').click()" style="background:#f79e12; padding:5px; margin-left:-20px;margin-top:5px;">Top Feature Home page slider Deal</p>
                                                </div>
                                            ...
                                            <div class="deals_work6">
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="col-lg-3">
                                                        <p style=" margin-left:-20px; margin-top:5px;">$3.5per</p>
                                                    </div>
                                                    <div class="col-lg-2">
