              ...
              <?php } ?>  </div>
                <div class="col-lg-12">
                    ...
                    <br>
                        ...
                        <p><a href="mydeals.php"><button type="button" class="btn btn-lg btn-success btn2" id="mydeals" style="margin-left:0px; margin-top:15px;">My Deals</button></a></p>           
                  ...
                  <div class="table-responsive">
                        <table class="table table-bordered">
							...
							$count = 1; 
                             ...
                             $adssql=mysql_query("SELECT * FROM `deals` WHERE user_id='$user_id' LIMIT $limit");
                             $sn=0;
                            ...
                            <tr>
                                ...
                                <td style="padding-left:20px;"><?php echo $ads['deals_title']; ?></td>
                                <td style="padding-left:20px;" width="220px">
                                    <a class="btn btn-sm btn-success btn1" href="getdeals.php?id=<?php echo $ads['id']; ?>">View</a>
                                    <a class="btn btn-sm btn-success btn1" href="editdeals.php?id=<?php echo $ads['id']; ?>">Edit</a>
...
<!--                                    <button type="button" class="btn btn-sm btn-success btn1">Extended</button>-->
                                   ...
                                   ?>
                                      <button type="button" class="btn btn-sm btn-success btn1">Extend</button> 
                                    <?php }?>
                                </td>
                            </tr><?php } 
                            $sn=0;
                        ...
                        to the query string.*/ 
                        $off_sql = mysql_query ("SELECT * FROM `deals` WHERE user_id='$user_id'") or die ("Error in query: $off_sql".mysql_error()); 
