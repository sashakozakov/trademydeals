...
$(document).ready(function(){
 $(".deals_work5").hide();
  ...
  <body>
        ...
        <div class="col-lg-12">
            ...
            <div class="col-lg-3">
                <div class="col-lg-12">
                    ...
                    <div class="col-lg-6">
                        <button type="button" class="btn btn-sm btn-success btn2">Post Coupon</button>
                    </div>
                </div>
                <div class="col-lg-12">
        ...
        <div class="container-fluid">
         ...
         <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
              ...
              <li class="active"><a href="coupons.php">Coupons</a></li>
               <li class="dropdown">
    ...
    <form action="coupons_process.php" method="post" enctype="multipart/form-data">
    <div class="content">
        <div class="container">
            <div class="col-lg-12">
                <div class="col-lg-9">
                    <div class="deals_content">
                        ...
                        <div class="deals_form">
                            <div class="col-lg-12">
                                ...
                                <div class="col-lg-7">
                                      <input type="text" name="coupons_title" class="form-control">
                                </div>
                                <div class="col-lg-2">
                                </div>
                            </div>
                    ...
                    <div class="deals_content">
                        ...
                        <div class="deals_form">
                            ...
                            <div class="col-lg-12" style="margin-top:20px;">
                                ...
                                <div class="col-lg-7">
                                     <input type="text" name="city_coupons" class="form-control">
                                </div>
                                <div class="col-lg-2">
                                </div>
                            </div>
                            <div class="col-lg-12" style="margin-top:20px;">
                                ...
                                <div class="col-lg-7">
                                     <input type="text" name="postal_coupons" class="form-control">
                                </div>
                                <div class="col-lg-2">
                                </div>
                            </div>
                    ...
                    <div class="deals_content">
                        ...
                        <div class="deals_form">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="col-lg-7">
                                <p style="background:#f79e12; padding:5px; margin-left:-20px; margin-top:5px;">Regular - $20permonth(post will be on Coupon page)</p>
                                </div>
                 ...
                 <div class="col-lg-9">
                    <div class="deals_content">
                        ...
                        <div class="deals_form">
                            ...
                            <div class="col-lg-12">
                                <div class="col-lg-1">
                                    <input type="radio" name="promote_coupons" id="click2"  value="high">
                                </div>
                                <div class="col-lg-5">
                               <p style="background:#f79e12; padding:5px; margin-left:-20px; margin-top:5px;">Highlighted Coupon</p>
                                </div>
                                <div class="col-lg-6"></div>
                            </div>  
                            ...
                            <div class="col-lg-12">
                                ...
                                <p style=" margin-top:10px;">You'll have 5 highlited coupon inclueded+more</p>
                                ...
                                <div class="col-lg-3">
                                 <p style=" margin-left:-20px; margin-top:10px;">You'll have 10 highlited coupon inclueded+ a lot more</p>
                                 <button type="button" class="btn btn-sm btn-warning pull-right" style="margin-bottom:20px;">Read More</button>
                                </div>
                                <div class="col-lg-5">
                             ...
                             <div class="col-lg-12">
                                <div class="col-lg-1">
                                    <input type="radio" name="promote_coupons" id="click3"  value="top">
                                </div>
                                <div class="col-lg-5">
                                <p style="background:#f79e12; padding:5px; margin-left:-20px; margin-top:5px;">Top Coupon</p>
                                </div>
                                <div class="col-lg-6"></div>
                            </div>  
                            ...
                            <div class="col-lg-12">
                                ...
                                <p style=" margin-top:10px;">You'll have 3 top coupon inclueded+more</p>
                                    <button type="button" class="btn btn-sm btn-warning pull-right" style="margin-bottom:20px;">Read More</button>
                                </div>
                                <div class="col-lg-1">
                                ...
                                <div class="col-lg-3">
                                 <p style=" margin-left:-20px; margin-top:10px;">You'll have 6 top coupon inclueded+ a lot more</p>
                                 <button type="button" class="btn btn-sm btn-warning pull-right" style="margin-bottom:20px;">Read More</button>
                                </div>
                                <div class="col-lg-5">
                             ...
                             <div class="col-lg-12">
                                <div class="col-lg-1">
                                    <input type="radio" name="promote_coupons" id="click4" value="sidebar">
                                </div>
                                <div class="col-lg-5">
                                <p style="background:#f79e12; padding:5px; margin-left:-20px;margin-top:5px;">Sidebar Coupon</p>
                                </div>
                                <div class="col-lg-6"></div>
                            </div>   
                            ...
                            <div class="col-lg-12">
                                ...
                                <p style=" margin-top:10px;">You'll have 2 sidebar coupons inclueded+ a lot more</p>
                                    <button type="button" class="btn btn-sm btn-warning pull-right" style="margin-bottom:20px;">Read More</button>
                                </div>
                                <div class="col-lg-1">
                                ...
                                <div class="col-lg-3">
                                 <p style=" margin-left:-20px; margin-top:10px;">You'll have 4 sidebar coupons inclueded+ a lot more</p>
                                 <button type="button" class="btn btn-sm btn-warning pull-right" style="margin-bottom:20px;">Read More</button>
                                </div>
                                <div class="col-lg-5">
                            ...
                            <div class="col-lg-12">
                                <div class="col-lg-1">
                                    <input type="radio" name="promote_coupons" id="click5" value="slider">
                                </div>
                                <div class="col-lg-5">
                                <p style="background:#f79e12; padding:5px; margin-left:-20px;margin-top:5px;">Home Page Slider Coupon</p>
                                </div>
                                <div class="col-lg-6"></div>
                            </div> 
                            ...
                            <div class="col-lg-12">
                                ...
                                <p style=" margin-top:10px;">You'll have 1 home page coupons inclueded+more</p>
                                    <button type="button" class="btn btn-sm btn-warning pull-right" style="margin-bottom:20px;">Read More</button>
                                </div>
                                <div class="col-lg-1">
                                ...
                                <div class="col-lg-3">
                                 <p style=" margin-left:-20px; margin-top:10px;">You'll have 2 home page coupons inclueded+ a lot more</p>
                                 <button type="button" class="btn btn-sm btn-warning pull-right" style="margin-bottom:20px;">Read More</button>
                                </div>
                                <div class="col-lg-5">
