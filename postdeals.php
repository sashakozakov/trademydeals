...
<form action="deals_process.php" method="post" enctype="multipart/form-data" name="listForm" >
<?php 
} 
else{ ?>
<form action="paypal2/paypal2.php" method="post" enctype="multipart/form-data" name="listForm" >
<?php
}
?>
    <div class="content">
