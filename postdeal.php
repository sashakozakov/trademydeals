...
<form action="deals_process.php" method="post" enctype="multipart/form-data" name="listForm" id="listForm" >
    ...
    <form action="paypal2/paypal2.php?sandbox=1" method="post" enctype="multipart/form-data" name="listForm" id="listForm" >
        <?php
        }
        ?>
        <div class="content">
            <div class="container">
                    ...
                    <div class="col-lg-9">
                        <div class="col-lg-12">
                            <div class="deals_content">
                                <h4>Post Deal  &nbsp;&nbsp;&nbsp; - Only $20 per a month!</h4>
                                <div class="deals_sub">
                                    <h4>Deal Details</h4>
                                </div>
                                <div class="deals_form">
                                    <div class="col-lg-12 reg-nopad" style="margin-top:20px;">
                                        ...
                                        <div class="col-lg-7 reg-nopad">
                                            <select id="category" name="category" onchange="update_subcategory(this.value,1)">
                                    ...
                                    <div class="col-lg-12 reg-nopad">
                                        ...
                                        <div class="col-lg-7 reg-nopad">
                                            ...
                                            <input name="product" id="post_type" type="hidden" value="<?php echo "deals"; ?>">
                                ...
                                <div class="deals_form">
                                    ...
                                    <div class="col-lg-12 reg-nopad" style="margin-top:20px;">
                                        ...
                                        <div class="col-lg-7 reg-nopad">
                                            ...
                                            <input name="current_city" type="text" class="form-control" id="phone">
                                ...
                                <div class="deals_form">
                                    ...
                                    <div class="col-lg-12" style="margin-top:10px;" id="deals_click111">
                                        ...
                                        <div class="col-lg-8">
                                                ...
                                                <input type="file" id="file" name="file2" class="btn btn btn-primary btn6" value="Post Your Deal" accept="image/x-png, image/gif, image/jpeg"/><br />
                        ...
                        <script>
                            ...
                            j(function () {
                                ...
                                j('#fileupload').fileupload({
                                    url: url,
                                    dataType: 'json',
                                    done: function (e, data) { console.log('d');console.log(data);
              ...
              <div class="deals_work9">
                        ...
                        <div class="col-lg-12">
                            <p  style="margin-left:30px; margin-top:30px;"> By posting this Deal,you are agreeing with our <a href="#">terms and conditions</a></p>
                            <?php
                            if ($static['status']=='Pro Membership' OR $static['status']=='Gold Membership') {
                                ...
                                ?>
                                <p class="pull-right">
                                    <span style="font-weight:bold;font-family:arial;font-size:18px;">Total Price:</span>&nbsp;$ <input type="text" name="total" value="20" style="border:none; background:#e2e2e2;">
                                </p>
                            <?php } ?>
                        </div>
                        ...
                        <div class="col-lg-12 pull-right">
                            <!--input type="button" class="btn btn btn-primary pull-right btn6" name="btnPreview" id="btnPreview" value="Preview"-->
                            <input  id="div1" style="display:block;" type="submit" class="btn btn btn-primary pull-right btn6" value="Post My Deal" /><!--onclick="this.form.target='_blank';return true;"-->
                            <!--input  id="div2" type="submit" class="btn btn btn-primary pull-right btn6" value="Post My Deal" onclick="listForm.action='deals_process.php' ; return true;" -->
...
//
//        $(document).on('change', '#file', function(){ console.log($('#listForm').serializeArray());
//            $.ajax({
//                url: 'http://trademydeals.com/classes/Common.class.php',
//                data:  new FormData( $('#listForm') ),
//                processData: false,
//                contentType: false
//            }).done(function(data){
...
//        });
//
//        $(document).on('submit','#upload',function(e){e.preventDefault();
//            console.log('data');
//            $.ajax({
//                url: 'http://trademydeals.com/classes/Common.class.php',
...
//
            ...
            $('#btnPreview').on('click',function(){
                ...
                $.ajax({
                    url: 'http://trademydeals.com/dealPreview.php',
                    method:'POST',
                    data: formData,
                    success: function(data) {
    ...
    <div id="dialog1" title="Deal Preview"></div>
