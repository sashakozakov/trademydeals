            ...
            <div class="col-md-12 col-lg-12">
                <div class="col-md-12 col-lg-12">
                    <div class="newcontent">
                        ...
                        $top_query=mysql_query("SELECT * FROM `deals` WHERE `promote_deals1`='top'  and payment_status = '1' ORDER BY id desc LIMIT $limit"); //date_time DESC
                ...
                to the query string.*/
                $off_sql = mysql_query ("SELECT * FROM `deals` WHERE `promote_deals1`='top'  and payment_status = '1'") or die ("Error in query: $off_sql".mysql_error()); 
