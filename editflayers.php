...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <form action="" method="post" enctype="multipart/form-data" name="listForm" onsubmit="return checkFlyers();" >
                <input type="hidden" value="flyers" name="post_type" id="post_type" />
                        ...
                        <div class="col-lg-12">
                            <div class="col-lg-9">
                                <div class="col-lg-3">
                                    ...
                                    <p><a href="myflyers.php"><button type="button" class="btn btn-lg btn-success btn2" style="margin-top:3px">My Flyers</button></a></p>
                                    ...
                                    <div class="deals_content">
                                        ...
                                        <div class="deals_form">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="col-lg-7">
                                                    <input name="title" value="<?php echo $ads_details['flyers_title'];?>" id="title" type="text" class="form-control">
                                    ...
                                    <div class="deals_content">
                                        ...
                                        <div class="deals_form">
                                            ...
                                            <div class="col-lg-12" style="margin-top:20px;">
                                                ...
                                                <div class="col-lg-7">
                                                    <input value="<?php echo $ads_details['city_flyer'];?>" name="city" type="text" class="form-control">
                                                </div>
                                                <div class="col-lg-2">
                                                </div>
                                            </div>
                                            <div class="col-lg-12" style="margin-top:20px;">
                                                ...
                                                <div class="col-lg-7">
                                                    <input name="postalcode" value="<?php echo $ads_details['postalcode_flyer'];?>" type="text" class="form-control">
                                                </div>
                                                <div class="col-lg-2">
                                                </div>
                                            </div>
                                    ...
                                    <div class="deals_content">
                                        ...
                                        <div class="deals_form">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="col-lg-1">
                                                    <input type="checkbox" class="click111" <?php if(!empty($ads_details['flyers_images']) || is_array($ads_images)){echo "checked='checked';";}?>>
                                                </div>
                                                <div class="col-lg-2">
                                ...
                                <div class="col-lg-12">
                                    <div class="deals_content">
                                        ...
                                        <div class="deals_form">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="col-lg-1">
                                                    <input type="checkbox" id="chk1" <?php if($ads_details['promote_flyers']!=""){echo "checked='checked';";}?> class="click2" name="highlight" value="high" onClick="subtotal()">
                                                </div>
                                                <div class="col-lg-5">
                                                    <p onclick="$('.click2').click()" style="background:#f79e12; padding:5px; margin-left:-20px; margin-top:5px;">Hightlighted Flyer</p>
                                                </div>
                            ...
                            <div class="col-lg-12"> <?php
                              ...
                              <div class="col-lg-4" style="border:#fff solid 1px;">
                                ...
                                <div class="col-lg-1">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="col-lg-1">
                                                    <input type="checkbox" id="chk2" <?php if($ads_details['promote_flyers1']!=""){echo "checked='checked';";}?> class=" click3" name="promote_ads1" value="top"onClick="subtotalnew()">
                                                </div>
                                                <div class="col-lg-5">
                                                    <p onclick="$('.click3').click()" style="background:#f79e12; padding:5px; margin-left:-20px; margin-top:5px;">Top Flyer</p>
                                                </div>
                            ...
                            <div class="col-lg-12"> <?php
                              ...
                              <div class="col-lg-4" style="border:#fff solid 1px;">
                                ...
                                <div class="col-lg-1">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="col-lg-1">
                                                    <input type="checkbox" id='chk3' <?php if($ads_details['promote_flyers2']!=""){echo "checked='checked';";}?> class=" click4" name="promote_ads2" value="home" onClick="subtotalnew1()">
                                                </div>
                                                <div class="col-lg-5">
                                                    <p onclick="$('.click4').click()" style="background:#f79e12; padding:5px; margin-left:-20px; margin-top:5px;">Home page Gallery Flyer</p>
                                                </div>
              ...
              <div class="deals_work9">
                            ...
                            <div class="col-lg-12"> <?php
                              ...
                              <div class="col-lg-4" style="border:#fff solid 1px;">
                                ...
                                <div class="col-lg-1">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="col-lg-1">
                                                    <input type="checkbox" id="chk4" <?php if($ads_details['promote_flyers3']!=""){echo "checked='checked';";}?> class=" click5" name="promote_ads3" value="sidebar" onClick="subtotalnew2()">
                                                </div>
                                                <div class="col-lg-5">
                                                    <p onclick="$('.click5').click()" style="background:#f79e12; padding:5px; margin-left:-20px;margin-top:5px;">Sidebar Flyer</p>
                                                </div>
                            ...
                            <div class="col-lg-12"> <?php
                              ...
                              <div class="col-lg-4" style="border:#fff solid 1px;">
                                ...
                                <div class="col-lg-1">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="col-lg-1">
                                                    <input type="checkbox" id='chk5' <?php if($ads_details['promote_flyers4']!=""){echo "checked='checked';";}?> class=" click6" name="promote_ads4" value="slider" onClick="subtotalnew3()">
                                                </div>
                                                <div class="col-lg-5">
                                                    <p onclick="$('.click6').click()" style="background:#f79e12; padding:5px; margin-left:-20px;margin-top:5px;">Top Feature Home page slider Flyer</p>
                                                </div>
                       ...
                       <br>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <input type="submit" name="update_post" class="btn btn btn-primary pull-left btn6" value="Update Flyer" >
                                </div>
                            </div>
            </form>
            <?php
