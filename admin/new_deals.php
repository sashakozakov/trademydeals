...
<form action="deals_process.php" method="post" enctype="multipart/form-data" name="listForm" onsubmit="return checkDeals();" >
...
if ($static['status']=='Pro Membership' )
 ...
 <input type="submit" class="btn btn btn-primary pull-left btn6" value="Post My Deal" >  
				 </div>
                </div>
                 </form>
             <?php 
