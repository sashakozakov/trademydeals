                        ...
                        <div class="deals_form">
                            ...
                            <div class="col-lg-12" style="margin-top:20px;">
                                ...
                                <div class="col-lg-7">
                                    ...
                                    <p style="margin:5px 0 0"><input type="checkbox" value="1" id="share_phone" name="share_phone" <?php if($share_phone){ echo 'checked="checked"';}?> /> Share my phone number with others</p>
                                </div>
                                <div class="col-lg-2">
                                </div>
                            </div>
                            <div class="col-lg-12" style="margin-top:20px;">
                                ...
                                <div class="col-lg-7">
                                    ...
                                    <p style="margin:5px 0 0"><input type="checkbox" value="1" id="share_email" name="share_email" <?php if($ads_details['share_email']){ echo 'checked="checked"';}?> /> Share my email with others</p>
                                </div>
                                <div class="col-lg-2">
                                </div>
                            </div>
                      ...
                      <br>
                        ...
                        <div class="deals_form">
                            ...
                            <div class="col-lg-12" style="margin-top:10px;" id="deals_click11">
                                ...
                                <div class="col-lg-7">
                                      <input name="youtube" value="<?php echo $ads_details['youtube'];?>" type="text" class="form-control">
                                </div>
                                <div class="col-lg-2">
                                </div>
                            </div>  
...
<div class="post_image_box"><a id="img_box_link_<?php echo $ijk;?>" class="close_link"  onclick="unlink_file('<?php echo $ads_image['image'];?>',<?php echo $ijk;?>,<?php echo $ads_image['id'];?>)">Remove</a><img class= "post_images" id="img_box_<?php echo $ijk;?>" src='../img/<?php echo $ads_image['image'];?>' style=" margin-right: 10px;height: 80px;width: 100px;"/></div>
...
function unlink_file(file_name,counter_value,image_id){
    ...
    type:"POST",
    data:{file_name : file_name,image_id:image_id},
...
j(function () {
    ...
    j('#fileupload').fileupload({
        ...
        .parent().addClass(j.support.fileInput ? undefined : 'disabled');
			  ...
			  <div class="col-lg-12">
				  <div class="deals_content">
					  ...
					  <div class="deals_form">
						  ...
						  <div class="col-lg-12">
							  <div class="col-lg-1">
								  <input id="chk1" <?php if($ads_details['promote_resumes']) echo 'checked=checked';?> type="checkbox" class="click2" name="highlight" value="high"  onClick="showIPAddress(this);subtotal()" >
							  </div>
							  <div class="col-lg-5">
								  <p style="background:#f79e12; padding:5px; margin-left:-20px; margin-top:5px;width: 50%;">Hightlighted Resume</p>
							  </div><?php
						  ...
						  <div class="col-lg-12">
							  <div class="col-lg-1">
								  <input  id="chk2" <?php if($ads_details['promote_resumes1']) echo 'checked=checked';?> type="checkbox" class=" click3" name="promote_ads1" value="top" onClick="showIPAddress(this);subtotalnew()">
							  </div>
							  <div class="col-lg-5">
								  <p style="width: 50%;background:#f79e12; padding:5px; margin-left:-20px; margin-top:5px;">Top Resumes</p>
							  </div>
						  ...
						  <div class="col-lg-12">
							  <div class="col-lg-1">
								  <input  id="chk3" <?php if($ads_details['promote_resumes2']) echo 'checked=checked';?> type="checkbox" class=" click4" name="promote_ads2" value="home" onClick="showIPAddress(this);subtotalnew1()">
							  </div>
							  <div class="col-lg-5">
								  <p style="background:#f79e12; padding:5px; margin-left:-20px; margin-top:5px;width: 50%;">Home page Gallery Resumes</p>
							  </div>
              ...
              <div class="deals_work9">
						  ...
						  <div class="col-lg-12">
							  <div class="col-lg-1">
								  <input  id="chk4" <?php if($ads_details['promote_resumes3']) echo 'checked=checked';?> type="checkbox" class=" click5" name="promote_ads3" value="sidebar" onClick="showIPAddress(this);subtotalnew2()">
							  </div>
							  <div class="col-lg-5">
								  <p style="width: 50%;background:#f79e12; padding:5px; margin-left:-20px;margin-top:5px;">Sidebar Resume</p>
							  </div>
						  ...
						  <div class="col-lg-12">
							  <div class="col-lg-1">
								  <input id='chk5' <?php if($ads_details['promote_resumes4']) echo 'checked=checked';?> type="checkbox" class=" click6" name="promote_ads4" value="slider">
							  </div>
							  <div class="col-lg-5">
						  ...
						  <div class="deals_work6">
							  <div class="col-lg-12">
								  ...
								  if ($static['status']=='Pro Membership' OR $static['status']=='Gold Membership') {
									  ...
									  <div class="col-lg-1">
										  <input type="radio" checked name="sliderdeals" value="20" onClick="subtotalnew3()">
									  </div>
						  ...
						  <div class="col-lg-12">
							  <div class="col-lg-1">
								  <input id='chk6' <?php if($ads_details['promote_resumes5']) echo 'checked=checked';?> type="checkbox" class="click10" name="promote10" value="urgent1" onClick="showIPAddress(this);subtotal10()">
							  </div>
							  <div class="col-lg-5">
								  <p style="background:#f79e12; padding:5px; margin-left:-20px;margin-top:5px;">Urgent Resume</p>
							  </div>
 ...
 <input type="submit" name="update_post" class="btn btn btn-primary pull-left btn6" value="Update Resume" >
                     <a class="btn btn btn-primary pull-left btn6" href="/getresumes.php?id=<?php echo $_GET['id'];?>" target="_blank">View</a>
				 </div>
                </div>
                 </form>
             <?php 
