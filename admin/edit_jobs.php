...
<form action="" method="post" enctype="multipart/form-data" name="listForm" onsubmit="return checkJobs();" >
              ...
              <div class="col-lg-12">
                  <div class="deals_content">
					 ...
					 // echo $row['id']."==".$ads_details['user_id'];
					  ...
					  if($row['sub_menu_category_item'] == $ads_details['category-name']){
					  ?>
                      ...
                      ?>
						<option value="<?php echo $row['sub_menu_id']; ?>"><?php echo $row['sub_menu_category_item']; ?></option>
                          ...
                          <div class="col-lg-12" style="margin-top:20px;">
                                ...
                                <div class="col-lg-7">
                                      <input name="title" value="<?php echo $ads_details['jobs_title'];?>" id="title" type="text" class="form-control">
                        ...
                        <div class="deals_form">
                          <div class="col-lg-12">
                            ...
                            <div class="col-lg-12" style="margin-top:20px;">
                                ...
                                <div class="col-lg-7">
                                     <input value="<?php echo $ads_details['city_job'];?>" name="city" type="text" class="form-control">
                                </div>
                                <div class="col-lg-2">
                                </div>
                            </div>
                            <div class="col-lg-12" style="margin-top:20px;">
                                ...
                                <div class="col-lg-7">
                                     <input name="postalcode" value="<?php echo $ads_details['postalcode_job'];?>" type="text" class="form-control">
                                </div>
                                <div class="col-lg-2">
                                </div>
                            </div>
                        ...
                        <div class="deals_form">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="col-lg-2">
                                 ...
                                 <div class="col-lg-1">
                                    <input type="checkbox" class="click111" <?php if(!empty($ads_details['jobs_images']) || is_array($ads_images)){echo "checked='checked';";}?>>
                                </div>
                                <div class="col-lg-2">
...
j(function () {
    ...
    j('#fileupload').fileupload({
        ...
        .parent().addClass(j.support.fileInput ? undefined : 'disabled');
			  ...
			  <div class="col-lg-12">
				  <div class="deals_content">
					  ...
					  <div class="deals_form">
						  ...
						  <div class="col-lg-12">
							  <div class="col-lg-1">
								  <input id="chk1" <?php if($ads_details['promote_jobs']) echo 'checked=checked';?> type="checkbox" class="click2" name="highlight" value="high"  onClick="showIPAddress(this);subtotal()" >
							  </div>
							  <div class="col-lg-5">
								  <p style="background:#f79e12; padding:5px; margin-left:-20px; margin-top:5px;width: 50%;">Hightlighted Job</p>
							  </div><?php
						  ...
						  <div class="col-lg-12">
							  <div class="col-lg-1">
								  <input  id="chk2" <?php if($ads_details['promote_jobs1']) echo 'checked=checked';?> type="checkbox" class=" click3" name="promote_ads1" value="top" onClick="showIPAddress(this);subtotalnew()">
							  </div>
							  <div class="col-lg-5">
								  <p style="width: 50%;background:#f79e12; padding:5px; margin-left:-20px; margin-top:5px;">Top Jobs</p>
							  </div>
						  ...
						  <div class="col-lg-12">
							  <div class="col-lg-1">
								  <input  id="chk3" <?php if($ads_details['promote_jobs2']) echo 'checked=checked';?> type="checkbox" class=" click4" name="promote_ads2" value="home" onClick="showIPAddress(this);subtotalnew1()">
							  </div>
							  <div class="col-lg-5">
								  <p style="background:#f79e12; padding:5px; margin-left:-20px; margin-top:5px;width: 50%;">Home page Gallery Jobs</p>
							  </div>
              ...
              <div class="deals_work9">
						  ...
						  <div class="col-lg-12">
							  <div class="col-lg-1">
								  <input  id="chk4" <?php if($ads_details['promote_jobs3']) echo 'checked=checked';?> type="checkbox" class=" click5" name="promote_ads3" value="sidebar" onClick="showIPAddress(this);subtotalnew2()">
							  </div>
							  <div class="col-lg-5">
								  <p style="width: 50%;background:#f79e12; padding:5px; margin-left:-20px;margin-top:5px;">Sidebar Job</p>
							  </div>
						  ...
						  <div class="col-lg-12">
							  <div class="col-lg-1">
								  <input id='chk5' <?php if($ads_details['promote_jobs4']) echo 'checked=checked';?> type="checkbox" class=" click6" name="promote_ads4" value="slider">
							  </div>
							  <div class="col-lg-5">
						  ...
						  <div class="col-lg-12">
							  <div class="col-lg-1">
								  <input id="chk6" type="checkbox" <?php if($ads_details['promote_jobs5']) echo 'checked=checked';?> class="click10" name="promote10" value="urgent1" onClick="showIPAddress(this);subtotal10()">
							  </div>
							  <div class="col-lg-5">
 ...
 <input type="submit" name="update_post" class="btn btn btn-primary pull-left btn6" value="Update Job" >
                     <a class="btn btn btn-primary pull-left btn6" href="/getjobs.php?id=<?php echo $_GET['id'];?>" target="_blank">View</a>
				 </div>
                </div>
                 </form>
             <?php 
