...
{
	UpdatePost();
    header("Location: posted-feature.php?action=ads");
}
$ads_detail = getPostDetails($_REQUEST['id'],'ads');
$ads_details =$ads_detail[0];
$ads_images = getPostImagesByID($_REQUEST['id'],'ads');
...
<form action="" method="post" enctype="multipart/form-data" name="listForm" onsubmit="return checkAds();" >
                      ...
                      ?>
						<option value="<?php echo $row['sub_menu_category']; ?>"><?php echo $row['sub_menu_category']; ?></option>
                            ...
                            <div class="col-lg-12" style="margin-top:20px; margin-bottom: 20px;">
                                ...
                                <div class="col-lg-7">
                                    <select class="form-control" id="type" name="type">
                                        <option value="offer" <?php if($ads_details['type'] == "offer"){ echo 'selected="selected"';}?>>I am Offering</option>
                                        <option value="want" <?php if($ads_details['type'] == "want"){ echo 'selected="selected"';}?>>I Want</option>
                                    </select>
                                </div>
                                <div class="col-lg-2">
                                </div>
                            ...
                            <div class="col-lg-12" style="margin-bottom:20px;">
                                ...
                                <div class="col-lg-7">
                                    <input name="price" id="price" type="text" class="form-control" value="<?php echo $ads_details['price'];?>">
                                </div>
                                <div class="col-lg-2">
                                </div>
                            </div>
                          ...
                          <div class="col-lg-12">
                                ...
                                <div class="col-lg-7">
                                      <input name="title" value="<?php echo $ads_details['ads_title'];?>" id="title" type="text" class="form-control">
                        ...
                        <div class="deals_form">
                          <div class="col-lg-12">
                            ...
                            <div class="col-lg-12" style="margin-top:20px;">
                                ...
                                <div class="col-lg-7">
                                     <input name="city" value="<?php echo $ads_details['city_ad'];?>" type="text" class="form-control">
                                </div>
                                <div class="col-lg-2">
                                </div>
                            </div>
                            <div class="col-lg-12" style="margin-top:20px;">
                                ...
                                <div class="col-lg-7">
                                     <input name="postalcode" value="<?php echo $ads_details['postalcode_ad'];?>" type="text" class="form-control">
                                </div>
                                <div class="col-lg-2">
                                </div>
                            </div>
                        ...
                        <div class="deals_form">
                            ...
                            <div class="col-lg-12" style="margin-top:20px;">
                                ...
                                <div class="col-lg-7">
                                    ...
                                    <p style="margin:5px 0 0"><input type="checkbox" value="1" id="share_phone" name="share_phone" <?php if($ads_details['share_phone']){ echo 'checked="checked"';}?> /> Share my phone number with others</p>
                                </div>
                                <div class="col-lg-2">
                                </div>
                            </div>
                        ...
                        <div class="deals_form">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="col-lg-2">
                                 ...
                                 <div class="col-lg-1">
                                    <input type="checkbox" class="click111" <?php if(!empty($ads_details['ads_images']) || is_array($ads_images)){echo "checked='checked';";}?>>
                                </div>
                                <div class="col-lg-2">
...
<br><br><strong>Images should be of size 6000*4000 or Max file size 4MB. Limit 5 images. Extra images will be charged $1 each</strong>
                                ...
                                <div class="col-lg-8">
								<div class="col-lg-7">
                                       <input type="file" name="file2" class="btn btn btn-primary btn6" value="Post Your Deal" />
    ...
    j('#fileupload').fileupload({
        ...
        .parent().addClass(j.support.fileInput ? undefined : 'disabled');
					  ...
					  <div class="deals_form">
						  ...
						  <div class="col-lg-12">
							  <div class="col-lg-1">
								  ...
								  <input id="chk1" type="checkbox" class="click2"  <?php if($ads_details['promote_ads']) echo 'checked=checked';?> name="highlight" value="high"  onClick="showIPAddress(this);subtotal()" >
							  </div>
							  <div class="col-lg-5">
								  <p style="background:#f79e12; padding:5px; margin-left:-20px; margin-top:5px;width: 50%;">Hightlighted Ad</p>
							  </div><?php
						  ...
						  <div class="col-lg-12">
							  <div class="col-lg-1">
								  <input  id="chk2" type="checkbox" class=" click3" name="promote_ads1" <?php if($ads_details['promote_ads1']) echo 'checked=checked';?> value="top" onClick="showIPAddress(this);subtotalnew()">
							  </div>
							  <div class="col-lg-5">
								  <p style="width: 50%;background:#f79e12; padding:5px; margin-left:-20px; margin-top:5px;">Top Ads</p>
							  </div>
						  ...
						  <div class="col-lg-12">
							  <div class="col-lg-1">
								  <input  id="chk3" type="checkbox" class=" click4" name="promote_ads2" <?php if($ads_details['promote_ads2']) echo 'checked=checked';?>  value="home" onClick="showIPAddress(this);subtotalnew1()">
							  </div>
							  <div class="col-lg-5">
								  <p style="background:#f79e12; padding:5px; margin-left:-20px; margin-top:5px;width: 50%;">Home page Gallery Ads</p>
							  </div>
						  ...
						  <div class="deals_work4">
							  ...
							  <?php if ($static['status']=='Gold Membership' ){ } else { ?>
							  <div class="col-lg-12">
								  <div class="col-lg-1"></div>
								  <!--<div class="col-lg-1">
              ...
              <div class="deals_work9">
						  ...
						  <div class="col-lg-12">
							  <div class="col-lg-1">
								  <input  id="chk4" type="checkbox" class=" click5" name="promote_ads3" <?php if($ads_details['promote_ads3']) echo 'checked=checked';?> value="sidebar" onClick="showIPAddress(this);subtotalnew2()">
							  </div>
							  <div class="col-lg-5">
								  <p style="width: 50%;background:#f79e12; padding:5px; margin-left:-20px;margin-top:5px;">Sidebar Ad</p>
							  </div>
						  ...
						  <div class="deals_work5">
							  <div class="col-lg-12">
								  <div class="col-lg-1"></div>
								  <?php if ($static['status']=='Pro Membership' OR $static['status']=='Gold Membership') { } else { ?>
								  <div class="col-lg-1">
								  ...
								  <!--<?php if ($static['status']=='Gold Membership' ) { } else { ?>
                                        ...
                                        <div class="deals_work10">
                                            <div class="col-lg-12">
                                            <?php if ($static['status']=='Pro Membership' ) { } else { ?>
                            <div class="col-lg-2"></div>
						  ...
						  <div class="col-lg-12">
							  <div class="col-lg-1">
								  <input type="checkbox" id="chk5" class=" click6" <?php if($ads_details['promote_ads4']) echo 'checked=checked';?> name="promote_ads4" value="slider">
							  </div>
							  <div class="col-lg-5">
						  ...
						  <div class="deals_work6">
							  <div class="col-lg-12">
								  ...
								  <div class="col-lg-1">
									  <input type="radio" name="sliderdeals" value="20" checked onClick="subtotalnew3()">
								  </div>
								  <div class="col-lg-3">
				 ...
				 <div class="col-lg-12">
                     ...
                     <input type="submit" name="update_post" class="btn btn btn-primary pull-left btn6" value="Update Ad" >
                     <a class="btn btn btn-primary pull-left btn6" href="/getads.php?id=<?php echo $_GET['id'];?>" target="_blank">View</a>
