						...
						<div class="tab-content">
							<div class="tab-pane active" id="tab_1_1">
								<div class="row">
									...
									<div class="col-md-9">
										<h3>User</h3>
										<div class="row">
											<div class="col-md-6 profile-info data_user">
												<div class="row">
													<div class="col-md-5">
														<p>User Name</p>
													</div>
													...
													<div class="col-md-5">
														<p class="nickname"><?php echo $userdetail['nickname']; ?></p>
													</div>
												</div>
												<div class="row">
													<div class="col-md-5">
													...
													<div class="col-md-5">
														<p class="date"><?php echo $userdetail['date']; ?></p>
													</div>
												</div>
												<div class="row">
													<div class="col-md-5">
													...
													<div class="col-md-5">
														<p class="email"><?php echo $userdetail['email']; ?></p>
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-md-5">
														<p class="companyname"><?php echo $userdetail['companyname']; ?></p>
													</div>
												</div>
												<div class="row">
													<div class="col-md-5">
													...
													<div class="col-md-5">
														<p class="firstname"><?php echo $userdetail['firstname']; ?></p>
													</div>
												</div>
												<div class="row">
													<div class="col-md-5">
													...
													<div class="col-md-5">
														<p class="lastname"><?php echo $userdetail['lastname']; ?></p>
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-md-5">
														<p class="country"><?php echo $userdetail['country']; ?></p>
													</div>
												</div>
												<div class="row">
													<div class="col-md-5">
													...
													<div class="col-md-5">
														<p class="town"><?php echo $userdetail['town']; ?></p>
													</div>
												</div>
												<div class="row">
													<div class="col-md-5">
													...
													<div class="col-md-5">
														<p class="state"><?php echo $userdetail['state']; ?></p>
													</div>
												</div>
												<div class="row">
													<div class="col-md-5">
													...
													<div class="col-md-5">
														<p class="postalcode"><?php echo $userdetail['postalcode']; ?></p>
													</div>
												</div>
												<div class="row">
													<div class="col-md-5">
													...
													<div class="col-md-5">
														<p class="phone"><?php echo $userdetail['phone']; ?></p>
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-md-5">
														<p class="status"><?php echo $userdetail['status']; ?></p>
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-md-5">
														<p class="ip_address"><?php echo $userdetail['ip_address']; ?></p>
													</div>
												</div>
												<input type="button" class="btn btn-sm btn-success btn1" id="edit_user" value="Edit" style="margin-left:10px;float: right;">

											</div>
											<div class="col-md-6 profile-info edit_user" style="display:none;">
												<form action="" id="save_user">
													...
													<div class="row">
														...
														<div class="col-md-5">
															<p><input type="text"  name="date" value="<?php echo $userdetail['date']; ?>" /></p>
														</div>
													</div>
													<div class="row">
														<div class="col-md-5">
														...
														<div class="col-md-5">
															<p><input type="text"  name="email" value="<?php echo $userdetail['email']; ?>" /></p>
														</div>
													</div>
													...
													<div class="row">
														...
														<div class="col-md-5">
															<p><input type="text" name="companyname" value="<?php echo $userdetail['companyname']; ?>" /></p>
														</div>
													</div>
													<div class="row">
														<div class="col-md-5">
														...
														<div class="col-md-5">
															<p><input type="text" name="firstname" value="<?php echo $userdetail['firstname']; ?>" /></p>
														</div>
													</div>
													<div class="row">
														<div class="col-md-5">
														...
														<div class="col-md-5">
															<p><input type="text" name="lastname" value="<?php echo $userdetail['lastname']; ?>" /></p>
														</div>
													</div>
													...
													<div class="row">
														...
														<div class="col-md-5">
															<p><input type="text" name="country" value="<?php echo $userdetail['country']; ?>" /></p>
														</div>
													</div>
													<div class="row">
														<div class="col-md-5">
														...
														<div class="col-md-5">
															<p><input type="text" name="town" value="<?php echo $userdetail['town']; ?>" /></p>
														</div>
													</div>
													<div class="row">
														<div class="col-md-5">
														...
														<div class="col-md-5">
															<p><input type="text" name="state" value="<?php echo $userdetail['state']; ?>" /></p>
														</div>
													</div>
													<div class="row">
														<div class="col-md-5">
														...
														<div class="col-md-5">
															<p><input type="text" name="postalcode" value="<?php echo $userdetail['postalcode']; ?>" /></p>
														</div>
													</div>
													<div class="row">
														<div class="col-md-5">
														...
														<div class="col-md-5">
															<p><input type="text" name="phone" value="<?php echo $userdetail['phone']; ?>" /></p>
														</div>
													</div>
													...
													<div class="row">
														...
														<div class="col-md-5">
															<p><input type="text" name="status" value="<?php echo $userdetail['status']; ?>" /></p>
														</div>
													</div>
													...
													<div class="row">
														...
														<div class="col-md-5">
															<p><input type="text" name="ip_address" value="<?php echo $userdetail['ip_address']; ?>" /></p>
														</div>
													</div>
													<input type="hidden" name="id" value="<?php echo $id1; ?>" />
													<input type="hidden" name="func" value="update_user" />
													<input type="submit" class="btn btn-sm btn-success btn1"  value="Save" style="margin-left:10px;float: right;">
												</form>
											</div>
											<!--end col-md-8-->
							...
							<div class="tab-pane" id="tab_1_13">
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<?php
									$billingQuery=mysql_query("SELECT * FROM paypal_log WHERE user_id=".$id1."");
									while( $billingDetail=mysql_fetch_array($billingQuery)){
										$txn_id = $billingDetail['txn_id'];
										//echo "SELECT payer_email,payment_status FROM purchases WHERE trasaction_id='".$txn_id."'";
										$paymentQuery = mysql_query("SELECT payer_email,payment_status,product_name FROM purchases WHERE trasaction_id='".$txn_id."'");
										$paymentResult = mysql_fetch_array($paymentQuery);
										$postDate = strtotime($billingDetail['posted_date']);
										$date = date('m/d/Y',$postDate);
										?>
										<tr class="edit_billing">
											<td><?php echo $billingDetail['id'];?></td>
											<td><?php echo $billingDetail['txn_id'];?></td>
											<td><?php echo $paymentResult['product_name'];?></td>
											<td><?php echo $paymentResult['payment_status'];?></td>
											<td><?php echo $date;?></td>
											<td><?php echo $paymentResult['payer_email'];?></td>
											<td><?php echo $userdetail['status']; ?></td>
											<td><?php echo $billingDetail['payment'];?></td>
											<td><a href="view_billing.php?id=<?php echo $billingDetail['id'];?>&uid=<?php echo $id1;?>"><i class="fa fa-search"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="billing.php?id=<?php echo $billingDetail['id'];?>&uid=<?php echo $id1;?>"><i class=" fa fa-pencil"></i></a></td>
										</tr>
									<?php } ?>
								</table>
							</div>
...
<script>
	jQuery(document).ready(function() {
		$(document).on('click', '#edit_user', function(){	console.log('edit');
			$('.edit_user').show();
			$('.data_user').hide();
		});
		...
		$(document).on('submit', '#save_user', function(e){
			e.preventDefault();
			$.post('/classes/Common.class.php',$(this).serialize(),function( data ) {
				console.log(data);
