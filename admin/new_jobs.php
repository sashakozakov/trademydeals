...
<form action="jobs_process.php" method="post" enctype="multipart/form-data" name="listForm" onsubmit="return checkJobs();" >
...
if ($static['status']=='Pro Membership' )
 ...
 <input type="submit" class="btn btn btn-primary pull-left btn6" value="Post My Job" >  
				 </div>
                </div>
                 </form>
             <?php 
