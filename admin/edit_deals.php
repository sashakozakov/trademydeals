...
//echo "Gireesh";
if( $_SERVER['REMOTE_ADDR'] =='77.120.168.216'){
...
<form action="" method="post" enctype="multipart/form-data" name="listForm" onsubmit="return checkDeals();" >
   <input type="hidden" value="deals" name="post_type" id="post_type" />
					 ...
					 // echo $row['id']."==".$ads_details['user_id'];
                      ...
                      ?>
						...
						<div class="col-lg-12" style="margin-top:20px;">
                                ...
                                <div class="col-lg-7">
                                      <select class="form-control" id="category" name="category" onchange="update_subcategory(this.value,1)">
									  <option value="0">-Select Category-</option>
									  <?php $q = "SELECT DISTINCT sub_menu_category,main_menu_id
													FROM  `tbl_sub_menu` where main_menu_id ='1' ";
										$sql=  mysql_query($q);
                      ...
                      ?>
						<option value="<?php echo $row['sub_menu_category']; ?>"><?php echo $row['sub_menu_category']; ?></option>
                          ...
                          <div class="col-lg-12">
                                ...
                                <div class="col-lg-7">
                                      <input name="title" value="<?php echo $ads_details['deals_title'];?>" id="title" type="text" class="form-control">
                        ...
                        <div class="deals_form">
                          <div class="col-lg-12">
                            ...
                            <div class="col-lg-12" style="margin-top:20px;">
                                ...
                                <div class="col-lg-7">
                                     <input name="city" value="<?php echo $ads_details['city_deal'];?>" type="text" class="form-control">
                                </div>
                                <div class="col-lg-2">
                                </div>
                            </div>
                            <div class="col-lg-12" style="margin-top:20px;">
                                ...
                                <div class="col-lg-7">
                                     <input name="postalcode" value="<?php echo $ads_details['postalcode_deal'];?>" type="text" class="form-control">
                                </div>
                                <div class="col-lg-2">
                                </div>
                            </div>
                        ...
                        <div class="deals_form">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="col-lg-2">
                                 ...
                                 <div class="col-lg-1">
                                    <input type="checkbox" class="click111" <?php if(!empty($ads_details['deals_images']) || is_array($ads_images)){echo "checked='checked';";}?>>
                                </div>
                                <div class="col-lg-2">
...
<br><br><strong>Images should be of size 6000*4000 or Max file size 4MB. Limit 5 images. Extra images will be charged $1 each</strong>
								...
								<div class="col-lg-7">
									   ...
									   <img class= "post_images" src='../img/<?php echo $ads_details['deals_images'];?>' style=" margin-right: 10px;height: 80px;width: 100px;margin-top: 20px;margin-bottom: 20px;"/><br />
								</div>
<div class="col-lg-7">
...
j(function () {
    ...
    j('#fileupload').fileupload({
        ...
        .parent().addClass(j.support.fileInput ? undefined : 'disabled');
			  ...
			  <div class="col-lg-12">
				  <div class="deals_content">
					  ...
					  <div class="deals_form">
						  ...
						  <div class="col-lg-12">
							  <div class="col-lg-1">
								  <input id="chk1" type="checkbox" <?php if($ads_details['promote_deals']) echo 'checked=checked';?> class="click2" name="highlight" value="high"  onClick="showIPAddress(this);subtotal()" >
							  </div>
							  <div class="col-lg-5">
								  <p style="background:#f79e12; padding:5px; margin-left:-20px; margin-top:5px;width: 50%;">Hightlighted Deal</p>
							  </div><?php
						  ...
						  <div class="col-lg-12">
							  <div class="col-lg-1">
								  <input  id="chk2" <?php if($ads_details['promote_deals1']) echo 'checked=checked';?> type="checkbox" class=" click3" name="promote_ads1" value="top" onClick="showIPAddress(this);subtotalnew()">
							  </div>
							  <div class="col-lg-5">
								  <p style="width: 50%;background:#f79e12; padding:5px; margin-left:-20px; margin-top:5px;">Top Deal</p>
							  </div>
						  ...
						  <div class="col-lg-12">
							  <div class="col-lg-1">
								  <input  id="chk3" <?php if($ads_details['promote_deals2']) echo 'checked=checked';?> type="checkbox" class=" click4" name="promote_ads2" value="home" onClick="showIPAddress(this);subtotalnew1()">
							  </div>
							  <div class="col-lg-5">
								  <p style="background:#f79e12; padding:5px; margin-left:-20px; margin-top:5px;width: 50%;">Home page Gallery Deal</p>
							  </div>
              ...
              <div class="deals_work9">
						  ...
						  <div class="col-lg-12">
							  <div class="col-lg-1">
								  <input  id="chk4" <?php if($ads_details['promote_deals3']) echo 'checked=checked';?> type="checkbox" class=" click5" name="promote_ads3" value="sidebar" onClick="showIPAddress(this);subtotalnew2()">
							  </div>
							  <div class="col-lg-5">
								  <p style="width: 50%;background:#f79e12; padding:5px; margin-left:-20px;margin-top:5px;">Sidebar Deal</p>
							  </div>
						  ...
						  <div class="col-lg-12">
							  <div class="col-lg-1">
								  <input id="chk5" type="checkbox" <?php if($ads_details['promote_deals4']) echo 'checked=checked';?> class=" click6" name="promote_ads4" value="slider">
							  </div>
							  <div class="col-lg-5">
 ...
 <input type="submit" name="update_post" class="btn btn btn-primary pull-left btn6" value="Update Deal" >
                     <a class="btn btn btn-primary pull-left btn6" href="/getdeals.php?id=<?php echo $_GET['id'];?>" target="_blank">View</a>
				 </div>
                </div>
                 </form>
             <?php
...
$.ajax({
    url: "../ajax-get-subcat.php",
    type:"POST",
    data:{id : '<?php echo $ads_details['category-name'];?>',main_menu_id : 1,sub_cat_id:<?php echo $ads_details['sub-category-id'];?>},
    success:function(data){
      //console.log(data);
      //return false;
      $("#sub-category").html(data);
