    ...
    j('#fileupload').fileupload({
        ...
        .parent().addClass(j.support.fileInput ? undefined : 'disabled');
			  ...
			  <div class="col-lg-12">
				  <div class="deals_content">
					  ...
					  <div class="deals_form">
						  ...
						  <div class="col-lg-12">
							  <div class="col-lg-1">
								  <input id="chk1" <?php if($ads_details['promote_flyers']) echo 'checked=checked';?> type="checkbox" class="click2" name="highlight" value="high"  onClick="showIPAddress(this);subtotal()" >
							  </div>
							  <div class="col-lg-5">
						  ...
						  <div class="col-lg-12">
							  <div class="col-lg-1">
								  <input  id="chk2" <?php if($ads_details['promote_flyers1']) echo 'checked=checked';?> type="checkbox" class=" click3" name="promote_ads1" value="top" onClick="showIPAddress(this);subtotalnew()">
							  </div>
							  <div class="col-lg-5">
						  ...
						  <div class="col-lg-12">
							  <div class="col-lg-1">
								  <input  id="chk3" <?php if($ads_details['promote_flyers2']) echo 'checked=checked';?> type="checkbox" class=" click4" name="promote_ads2" value="home" onClick="showIPAddress(this);subtotalnew1()">
							  </div>
							  <div class="col-lg-5">
              ...
              <div class="deals_work9">
						  ...
						  <div class="col-lg-12">
							  <div class="col-lg-1">
								  <input  id="chk4" <?php if($ads_details['promote_flyers3']) echo 'checked=checked';?> type="checkbox" class=" click5" name="promote_ads3" value="sidebar" onClick="showIPAddress(this);subtotalnew2()">
							  </div>
							  <div class="col-lg-5">
						  ...
						  <div class="col-lg-12">
							  <div class="col-lg-1">
								  <input id="chk5" <?php if($ads_details['promote_flyers4']) echo 'checked=checked';?> type="checkbox" class=" click6" name="promote_ads4" value="slider" >
							  </div>
							  <div class="col-lg-5">
...
<!--						  </div>-->
 ...
 <input type="submit" name="update_post" class="btn btn btn-primary pull-left btn6" value="Update Flyer" >
                     <a class="btn btn btn-primary pull-left btn6" href="/getflyers.php?id=<?php echo $_GET['id'];?>" target="_blank">View</a>
				 </div>
                </div>
                 </form>
             <?php 
