                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab_1_1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" readonly value="<?php echo $billingDetail['txn_id']; ?>"  class="form-control" name="txn_id" id="txn_id" placeholder="Oreder ID">
                                        </div>
                                        <div class="col-sm-4">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" readonly value="<?php echo $paymentResult['product_name']; ?>"  class="form-control" name="product_name" id="product_name" placeholder="Product Name">
                                        </div>
                                        <div class="col-sm-4">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" readonly value="<?php echo $paymentResult['payment_status']; ?>"  class="form-control" name="payment_status" id="payment_status" placeholder="Payment Status">
                                        </div>
                                        <div class="col-sm-4">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" readonly value="<?php echo $date; ?>"  class="form-control" name="date" id="date" placeholder="Payment Date">
                                        </div>
                                        <div class="col-sm-4">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" readonly value="<?php echo $paymentResult['payer_email']; ?>"  class="form-control" name="payer_email" id="payer_email" placeholder="Email">
                                        </div>
                                        <div class="col-sm-4">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" readonly value="<?php echo $userdetail['status']; ?>"  class="form-control" name="status" id="status" placeholder="Type">
                                        </div>
                                        <div class="col-sm-4">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" readonly value="<?php echo $billingDetail['payment']; ?>"  class="form-control" name="payment" id="payment" placeholder="Payment Method">
                                        </div>
                                        <div class="col-sm-4">
                                        </div>
                                    </div>
