...
<form action="coupons_process.php" method="post" enctype="multipart/form-data" name="listForm" onsubmit="return checkCoupons();" >
...
if ($static['status']=='Pro Membership' OR $static['status']=='Gold Membership') {
 ...
 <input type="submit" class="btn btn btn-primary pull-left btn6" value="Post My Coupon" >  
				 </div>
                </div>
                 </form>
             <?php 
