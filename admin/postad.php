...
<form action="paypal2/paypal2.php?sandbox=1" method="post" enctype="multipart/form-data" name="listForm" id="listForm" onsubmit="return checkAds();">
<?php
}
?>
                          ...
                          <div class="col-lg-12">
                                ...
                                <div class="col-lg-7">
                                      ...
                                      <input type="hidden" name="action" value="process" />
                                       ...
                                       <input name="product" type="hidden" value="<?php echo "ads"; ?>">
...
j(function () {
  ...
  function showIPAddress(chk) {
      ...
      document.getElementById("div2").style.display = chk.checked ? "none" : "block";
                            ...
                            <div class="col-lg-12">
                                <div class="col-lg-1">
                                    <input id="chk1" value="1" type="checkbox" class="click2" name="highlight" value="high"  onClick="showIPAddress(this);subtotal()" >
                                </div>
                                <div class="col-lg-5">
                                <p style="background:#f79e12; padding:5px; margin-left:-20px; margin-top:5px;">Hightlighted Ad</p>
                                </div><?php 
if ($static['status']=='Pro Membership' OR $static['status']=='Gold Membership') 
...
if ($static['status']=='Pro Membership' )
                         ...
                         { }
                             ...
                             <div class="col-lg-12">
                                <div class="col-lg-1">
                                    <input  id="chk1" value="1" type="checkbox" class=" click3" name="promote_ads1" value="top" onClick="showIPAddress(this);subtotalnew()">
                                </div>
                                <div class="col-lg-5">
                                <p style="background:#f79e12; padding:5px; margin-left:-20px; margin-top:5px;">Top Ads</p>
                                </div>
...
if ($static['status']=='Pro Membership' )
                         ...
                         { }
                           ...
                           <div class="col-lg-12">
                                <div class="col-lg-1">
                                    <input  id="chk1" value="1" type="checkbox" class=" click4" name="promote_ads2" value="home" onClick="showIPAddress(this);subtotalnew1()">
                                </div>
                                <div class="col-lg-5">
                                <p style="background:#f79e12; padding:5px; margin-left:-20px; margin-top:5px;">Home page Gallery Ads</p>
                                </div>
...
if ($static['status']=='Pro Membership' )
                         ...
                         { }
                             ...
                             <div class="col-lg-12">
                                <div class="col-lg-1">
                                    <input  id="chk1" value="1" type="checkbox" class=" click5" name="promote_ads3" value="sidebar" onClick="showIPAddress(this);subtotalnew2()">
                                </div>
                                <div class="col-lg-5">
                                <p style="background:#f79e12; padding:5px; margin-left:-20px;margin-top:5px;">Sidebar Ad</p>
                                </div>
...
if ($static['status']=='Pro Membership' OR $static['status']=='Gold Membership') { } else {?> <p class="pull-right"><span style="font-weight:bold;font-family:arial;font-size:18px;">Total Price:</span>:&nbsp;$ <input type="text" name="total" id="total" value="0" style="border:none; background:#e2e2e2;"> </p><?php } ?>
 ...
 <input  id="div2" type="submit" class="btn btn btn-primary pull-right btn6" value="Post My Ad" onclick="listForm.action='postfree.php' ; return true;" >
				 </div>
                </div>
                 </form>
             <?php 
