...
<form action="ads_process.php" method="post" enctype="multipart/form-data" name="listForm" onsubmit="return checkAds();" >
...
if ($static['status']=='Pro Membership' )
 ...
 <input type="submit" class="btn btn btn-primary pull-left btn6" value="Post My Ad" >  
				 </div>
                </div>
                 </form>
             <?php 
