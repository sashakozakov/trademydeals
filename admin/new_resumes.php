...
<form action="resumes_process.php" method="post" enctype="multipart/form-data" name="listForm" onsubmit="return checkResumes();" >
...
if ($static['status']=='Pro Membership' )
 ...
 <input type="submit" class="btn btn btn-primary pull-left btn6" value="Post My Resume" >  
				 </div>
                </div>
                 </form>
             <?php 
