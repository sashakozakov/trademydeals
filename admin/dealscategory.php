                                        	...
                                        	<thead>
                                                ...
                                                <tr>
                                                   <td><?php echo $row['sub_menu_category_item']; ?></td> 
                                                    <td><a href="select_deals_item.php?main_menu_id=<?php echo $main_menu_id; ?>&sub_menu_id=<?php echo $row['sub_menu_id']; ?>" data-toggle="modal" class="config"><button id="btn_edit" class="btn green btn-sm">Edit</button></a></td>
									...
									<div class="col-md-12">
                                    	<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                        	<thead>
                                                ...
                                                <tr>
                                                   <td><?php echo $row['sub_menu_category_item']; ?></td> 
                                                   <td><a href="select_deals_item.php?main_menu_id=<?php echo $main_menu_id; ?>&sub_menu_id=<?php echo $row['sub_menu_id']; ?>" data-toggle="modal" class="config"><button id="btn_edit" class="btn green btn-sm" value="<?php echo $row['sub_menu_id']; ?>">Edit</button></a></td>
                                                    <td><button  class="btn green btn-sm btn_del" value="<?php echo $row['sub_menu_id']; ?>">Delete</button></td>
                                                </tr>
                                                <?php
												}
