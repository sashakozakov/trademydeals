...
count_post_views($page,$id);
                   $single_query=mysql_query("SELECT * FROM `resumes` WHERE `id`='$id' ");     
        ...
        <div class="container">
            <div class="col-lg-12">
                    ...
                    <div class="col-lg-9">
                        ...
                        <h4 style="color:#CC0000;"><?php echo $single['resumes_title']; ?>
                        ...
                        <div class="col-lg-5 " style="margin-top:10px;"><br>
                          <?php if($single['resumes_images']!=""){?>	
                        	<img src="img/<?php echo $single['resumes_images']; ?>" class="img-responsive">
							<?php } ?>
                        </div>
                        ...
                        <div class="col-lg-6"><br>
                            ...
                            <?php } ?>
                            <p style="margin-left:30px;"><span class="glyphicon glyphicon-globe" style="margin-right:10px;"></span>Website:&nbsp;<a href="<?php echo $single['websitelink'];?>"><?php echo $single['websitelink']; ?></a></p>
...
<?php //echo $single['description']; ?></p>
<?php $data_images = getPostImages($_REQUEST['id'],'resumes'); if(count($data_images)){?>	
<div class="slider1">
                   ...
                   ?>
                         <div class="col-lg-4">
                            <div class="content2" style="margin-top:10px;">
                                        <img src="img/<?php echo get_post_image($top->id,'resumes');?>" class="img-responsive">
                                       <a href="getresumes.php?id=<?php echo $top['id']; ?>"><h3><?php echo get_post_tile_string($top['resumes_title']); ?></h3>
                    ...
                    <div class="getads1 modal-demo" id="modal">
                     <form action="process1.php" method="post" name="request" id="request" enctype="multipart/form-data" onsubmit="return checkform();">
                        ...
                        <input type="hidden" name="option" id="option" value="resumes" />
