...
$(document).ready(function(){
 $(".deals_work5").hide();
  ...
  <body>
    ...
    <div class="logo">
        ...
        <div class="col-lg-12">
            ...
            <div class="col-lg-3">
                <div class="col-lg-12">
                    <div class="col-lg-6">
                        <button type="button" class="btn btn-sm btn-success btn1">Post Jobs Free</button>
                    </div>
                    <div class="col-lg-6">
                        <button type="button" class="btn btn-sm btn-success btn2">Post Jobs</button>
                    </div>
                </div>
                <div class="col-lg-12">
    ...
    <div class="menu" style="border:none;">
        ...
        <div class="container-fluid">
         ...
         <div class="navbar-collapse collapse">
	        ...
	        </li><li  class="active"><a href="jobs.php">Jobs</a></li><li class="dropdown">
    ...
    <form action="jobs_process.php" method="post" enctype="multipart/form-data">
    <div class="content">
        <div class="container">
            <div class="col-lg-12">
                <div class="col-lg-9">
                    <div class="deals_content">
                        ...
                        <div class="deals_form">
                            <div class="col-lg-12">
                                <div class="col-lg-3">
                                    <p>Jobs Title<i style="margin-left:10px; color:#CC0000;">*</i></p>
                                </div>
                                <div class="col-lg-7">
                                ...
                                <div class="col-lg-1">
                                <p style="margin-left:-30px; margin-top:5px;">Urgent&nbsp;jobs $50</p>
                                </div>
                            </div>
                    ...
                    <div class="deals_content">
                        ...
                        <div class="deals_form">
                            ...
                            <div class="col-lg-12" style="margin-top:20px;">
                                ...
                                <div class="col-lg-7">
                                     <input type="text" name="city_jobs" class="form-control">
                                </div>
                                <div class="col-lg-2">
                                </div>
                            </div>
                            <div class="col-lg-12" style="margin-top:20px;">
                                ...
                                <div class="col-lg-7">
                                     <input type="text" name="postal_jobs" class="form-control">
                                </div>
                                <div class="col-lg-2">
                                </div>
                            </div>
                    ...
                    <div class="deals_content">
                        ...
                        <div class="deals_form">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="col-lg-7">
                                <p style="background:#f79e12; padding:5px; margin-left:-20px; margin-top:5px;">Regular - $20permonth(post will be on Jobs page)</p>
                                </div>
                 ...
                 <div class="col-lg-9">
                    <div class="deals_content">
                        ...
                        <div class="deals_form">
                            ...
                            <div class="col-lg-12">
                                <div class="col-lg-1">
                                    <input type="radio" name="promote_jobs" id="click2"  value="high">
                                </div>
                                <div class="col-lg-5">
                               <p style="background:#f79e12; padding:5px; margin-left:-20px; margin-top:5px;">Highlighted Jobs</p>
                                </div>
                                <div class="col-lg-6"></div>
                            </div>  
                            ...
                            <div class="col-lg-12">
                                ...
                                <p style=" margin-top:10px;">You'll have 5 highlited Jobs inclueded+more</p>
                                ...
                                <div class="col-lg-3">
                                 <p style=" margin-left:-20px; margin-top:10px;">You'll have 10 highlited Jobs inclueded+ a lot more</p>
                                 <button type="button" class="btn btn-sm btn-warning pull-right" style="margin-bottom:20px;">Read More</button>
                                </div>
                                <div class="col-lg-5">
                             ...
                             <div class="col-lg-12">
                                <div class="col-lg-1">
                                    <input type="radio" name="promote_job" id="click3"  value="top">
                                </div>
                                <div class="col-lg-5">
                                <p style="background:#f79e12; padding:5px; margin-left:-20px; margin-top:5px;">Top Jobs</p>
                                </div>
                                <div class="col-lg-6"></div>
                            </div>  
                            ...
                            <div class="col-lg-12">
                                ...
                                <p style=" margin-top:10px;">You'll have 3 top Jobs inclueded+more</p>
                                    <button type="button" class="btn btn-sm btn-warning pull-right" style="margin-bottom:20px;">Read More</button>
                                </div>
                                <div class="col-lg-1">
                                ...
                                <div class="col-lg-3">
                                 <p style=" margin-left:-20px; margin-top:10px;">You'll have 6 top Jobs inclueded+ a lot more</p>
                                 <button type="button" class="btn btn-sm btn-warning pull-right" style="margin-bottom:20px;">Read More</button>
                                </div>
                                <div class="col-lg-5">
                             ...
                             <div class="col-lg-12">
                                <div class="col-lg-1">
                                    <input type="radio" name="promote_job" id="click4" value="sidebar">
                                </div>
                                <div class="col-lg-5">
                                <p style="background:#f79e12; padding:5px; margin-left:-20px;margin-top:5px;">Sidebar Jobs</p>
                                </div>
                                <div class="col-lg-6"></div>
                            </div>   
                            ...
                            <div class="col-lg-12">
                                ...
                                <p style=" margin-top:10px;">You'll have 2 sidebar Jobs inclueded+ a lot more</p>
                                    <button type="button" class="btn btn-sm btn-warning pull-right" style="margin-bottom:20px;">Read More</button>
                                </div>
                                <div class="col-lg-1">
                                ...
                                <div class="col-lg-3">
                                 <p style=" margin-left:-20px; margin-top:10px;">You'll have 4 sidebar Jobs inclueded+ a lot more</p>
                                 <button type="button" class="btn btn-sm btn-warning pull-right" style="margin-bottom:20px;">Read More</button>
                                </div>
                                <div class="col-lg-5">
                            ...
                            <div class="col-lg-12">
                                <div class="col-lg-1">
                                    <input type="radio" name="promote_job" id="click5" value="slider">
                                </div>
                                <div class="col-lg-5">
                                <p style="background:#f79e12; padding:5px; margin-left:-20px;margin-top:5px;">Home Page Slider Jobs</p>
                                </div>
                                <div class="col-lg-6"></div>
                            </div> 
                            ...
                            <div class="col-lg-12">
                                ...
                                <p style=" margin-top:10px;">You'll have 1 home page Jobs inclueded+more</p>
                                    <button type="button" class="btn btn-sm btn-warning pull-right" style="margin-bottom:20px;">Read More</button>
                                </div>
                                <div class="col-lg-1">
                                ...
                                <div class="col-lg-3">
                                 <p style=" margin-left:-20px; margin-top:10px;">You'll have 2 home page Jobs inclueded+ a lot more</p>
                                 <button type="button" class="btn btn-sm btn-warning pull-right" style="margin-bottom:20px;">Read More</button>
                                </div>
                                <div class="col-lg-5">
                    ...
                    <input type="submit" class="btn btn btn-primary pull-right btn6" value="Post Your Job"/>  
                 </div>
