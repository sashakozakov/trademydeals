...
border-bottom-right-radius:10px; margin-left:0px;">Post Job</button></a>
                      ...
                      <h4>Jobs&nbsp;->&nbsp;<a href="#" style="color:#000000; text-decoration:underline;"><?php echo $_REQUEST['product'];?></a></h4>
                    </div>
                   <?php }else{?> <div class="sub1 " style="background:#FFCC33; border:#FFCC33 solid 1px; border-radius:0px; ">
                      <h4>Top Jobs &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="top-jobs.php" style="color:#000; font-size:13px; text-decoration:underline;font-weight:700;">See all Top Jobs</a></h4>
                    </div> <?php } ?>

					<?php if(!isset($_REQUEST['product'])){
                   $top_query=mysql_query("SELECT * FROM `jobs` WHERE `promote_jobs1`='top'  and payment_status = '1' and country =  '$country_name' ORDER BY date_time DESC");
                  while ($top=mysql_fetch_array($top_query)) {
                   ?>
                    ...
                    </div><?php } }else{ $top_query=mysql_query("SELECT * FROM `jobs` WHERE `sub-category-id`= '".$_REQUEST['id']."'  and payment_status = '1' and country =  '$country_name' ORDER BY date_time DESC");
                ...
                <div class="col-lg-12" style=" margin-top:20px; display:<?php echo $none_all_ads;?>;" >
                  <div class="sub1 col-lg-12" style="background:#b97a57; border:#FFCC33 solid 1px; border-radius:0px;">
                      <h4>Urgent Jobs &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="urgent-jobs.php" style="color:#000; font-size:13px; text-decoration:underline;font-weight:700;">See all Urgent Jobs</a></h4>
                    </div> <?php
                   $urgent=mysql_query("SELECT * FROM `jobs` WHERE `urgent`='urgent'  and payment_status = '1' and country =  '$country_name' ORDER BY `date_time` DESC");
                  while ($urgent1=mysql_fetch_array($urgent)) {
                   ?>
                    <div class="col-lg-12 content3"  >
                      <div class="col-lg-2">
                          <img src="img/<?php echo get_post_image($urgent1['id'],'jobs');?>" class="img-responsive">
                        </div>
                        <div class="col-lg-10  ">
                           <a href="getjobs.php?id=<?php echo $urgent1['id']; ?>"><h3 style="margin-left:20px;"><?php echo get_post_tile_string($urgent1['jobs_title']); ?></h3></a>
...
//$query = "SELECT * FROM `jobs` where   promote_jobs = 'high'   ORDER BY id desc";
$query = "(SELECT * FROM `jobs` where  (promote_jobs = 'high' or promote_jobs = '') and payment_status = '1' and country =  '$country_name' ORDER BY promote_jobs DESC, date_time desc )";
...
<div class="col-lg-12  content3" style=" border:#CC0000 solid 4px;" >
    ...
    <div class="col-lg-12  content3" ><?php
                      ...
                      <div class="col-lg-2">
                          <img src="img/<?php echo get_post_image($row->id,'jobs');?>" class="img-responsive">
                        </div>
                        <div class="col-lg-10  ">
                           <a href="getjobs.php?id=<?php echo $row->id; ?>"><h3 style="margin-left:20px;"><?php echo get_post_tile_string($row->jobs_title); ?></h3>
