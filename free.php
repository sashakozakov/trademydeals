   ...
   <div class="content">
   	<div class="container">
        	...
        	<div class="col-lg-9">
            	<div class="col-lg-12">
                    ...
                    <form action="free_process.php" method="post"> 
                    <div class="col-lg-12">
                        <div class="col-lg-7">
                        <div class="col-lg-12">
    ...
    <input type="hidden" name="currency_code" value="USD" />
                   ...
                   <br>
                     ...
                     <div class="col-lg-4">
                       <button type="submit" class="btn btn-warning" style=" margin-top:20px;background:#000000; color:#FFFFFF;">PROCEED TO PAYPAL</button>
                           </div> 
                           </div>                         
                        </form>          
         </div>
