    	...
    	<div class="container">
        	<div class="col-lg-12">
                	...
                	<div class="col-lg-9 ads">
                    	<h4 style="color:#CC0000;">Resume Name
                        <a href="resume1.php"><button type="button" class="btn  btn-danger pull-right">Contact Author</button></h4></a>
                	...
                	<div class="sub1 col-lg-12" style="background:#FFCC33; border:#FFCC33 solid 1px; border-radius:0px;">
                    	<h4>Top Resumes &nbsp;&nbsp;&nbsp;<a href="#" style="color:#000000; text-decoration:underline;">see all TopResumes</a></h4>
                    </div>
                    <div class="col-lg-12 content3" style="background:#f4fcdd;" >
                    	<div class="col-lg-1">
                        	<img src="images/face1.png" style="margin-left:-30px;">
                        </div>
                        <div class="col-lg-11  ">
                        	 <a><h3 style="margin-left:20px;">Resume Name</h3></a>
                                        <p style="margin-left:20px;">Dropdowns are automatically positioned via CSS within the normal flow of the document. This means dropdowns may be cropped by parents with certain overflow properties or appear out of bounds of the viewport.</p>
