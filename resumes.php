                  ...
                  while ($top=mysql_fetch_array($top_query)) {
                   ?>
                    ...
                    <div class="col-lg-12 content3" style="background:#f4fcdd;" >
                      <div class="col-lg-1">
                          <img class="img-responsive" src="img/<?php echo get_post_image($top['id'],'resumes');?>" width="100px" height="70px">
                        </div>
                        <div class="col-lg-11  ">
                  ...
                  while ($urgent1=mysql_fetch_array($urgent)) {
                   ?>
                    <div class="col-lg-12 content3"  >
                      <div class="col-lg-1">
                          <img class="img-responsive" src="img/<?php echo get_post_image($urgent1['id'],'resumes');?>" width="100px" height="70px">
                        </div>
                        <div class="col-lg-11  ">
...
<div class="col-lg-12  content3" style=" border:#CC0000 solid 4px;" >
    ...
    <div class="col-lg-12  content3" ><?php
                ...
                <div class="col-lg-9 media-pagination">
                  <?php
