...
count_post_views($page,$id);
                   $single_query=mysql_query("SELECT * FROM `jobs` WHERE `id`='$id' ");     
    	...
    	<div class="container">
        	<div class="col-lg-12">
                	...
                	<div class="col-lg-9">
                    	...
                    	<h4 style="color:#CC0000;"><?php echo $single['jobs_title']; ?>
						...
						<?php if($single['jobs_images']!=""){?>	 
                        	<img src="img/<?php echo $single['jobs_images']; ?>" class="img-responsive">
							<?php } ?>
                        </div>
...
<?php $data_images = getPostImages($_REQUEST['id'],'jobs'); if(count($data_images)){?>	
<div class="slider1">
                   ...
                   ?>
                         <div class="col-lg-4">
                            <div class="content2" style="margin-top:10px;">
                                       ...
                                       <a href="getjobs.php?id=<?php echo $top['id']; ?>"><h3><?php echo get_post_tile_string($top['jobs_title']); ?></h3>
                    ...
                    <div class="getads1 modal-demo" id="modal">
                     <form action="process1.php" method="post" name="request" id="request" enctype="multipart/form-data" onsubmit="return checkform();">
                        ...
                        <input type="hidden" name="option" id="option" value="jobs" />
