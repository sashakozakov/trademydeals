...
border-bottom-right-radius:10px; margin-left:0px;">Post Resumes</button></a>
                  ...
                  <div class="sub1 " style="background:#FFCC33; border:#FFCC33 solid 1px; border-radius:0px; ">
                      <h4>Top Resumes &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" style="color:#000; font-size:13px; text-decoration:underline;font-weight:700;">See all Top Resumes</a></h4>
                    </div>
                    <?php 
                   $top_query=mysql_query("SELECT * FROM `resumes` WHERE `promote_resumes1`='top' ORDER BY `id` DESC");     
                   ...
                   ?>
                    ...
                    <div class="col-lg-12 content3" style="background:#f4fcdd;" >
                      <div class="col-lg-1">
                        ...
                        <div class="col-lg-11  ">
                           <a href="getresumes.php?id=<?php echo $top['id']; ?>"><h3 style="margin-left:20px;"><?php echo $top['resumes_title']; ?></h3>
                ...
                <div class="col-lg-12" style=" margin-top:20px;">
                  <div class="sub1 col-lg-12" style="background:#b97a57; border:#FFCC33 solid 1px; border-radius:0px;">
                      <h4>Urgent Resumes &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" style="color:#000; font-size:13px; text-decoration:underline;font-weight:700;">See all Urgent Jobs</a></h4>
                    </div> <?php 
                   $urgent=mysql_query("SELECT * FROM `resumes` WHERE `urgent`='urgent' ORDER BY `id` DESC");     
                   ...
                   ?>
                    <div class="col-lg-12 content3"  >
                      <div class="col-lg-1">
                        ...
                        <div class="col-lg-11  ">
                           <a href="getresumes.php?id=<?php echo $urgent1['id']; ?>"><h3 style="margin-left:20px;"><?php echo $urgent1['resumes_title']; ?></h3></a>
                ...
                <div class="col-lg-12" style="margin-top:20px;">
                  <div class="sub1 col-lg-12" style="background:#4ca6e1; border:#FFCC33 solid 1px; border-radius:0px;">
                      ...
                      $filename = "resume.php"; // name of this file 
...
<div class="col-lg-12  content3" style=" border:#CC0000 solid 4px;" >
    ...
    <div class="col-lg-12  content3" ><?php
                      ...
                      <div class="col-lg-1">
                        ...
                        <div class="col-lg-11  ">
                           <a href="getresumes.php?id=<?php echo $row->id; ?>"><h3 style="margin-left:20px;"><?php echo $row->resumes_title; ?></h3>
