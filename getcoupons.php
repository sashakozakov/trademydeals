...
$single_query = mysql_query("SELECT * FROM `coupons` WHERE `id`='$id' ");
        ...
        <div class="container">
            <div class="col-lg-12">
                ...
                <div class="col-lg-9 ads">
                    <div class="col-lg-12">
                        <h4 style="color:#CC0000;"><?php echo $single['coupon']; ?>

                            <?php
                            if (preg_match('/http\:\/\//', $single['websitelink'])) {
                                echo '<a target="_blank" href="' . $single['websitelink'] . '">';
                                echo '<button type="button" class="btn btn-danger pull-right">Get Deal&nbsp;&nbsp;';
                        ...
                        <p style="border-bottom:#CC0000 solid 2px; font-size:12px;">Total
                            views:<?php echo $single['views_count']; ?></p>
                        <?php $date = explode(' ', $single['date_time']); ?>
                        <?php $date2 = explode('/', $single['exp_date']);
                        $date2 = ($date2[0] == '') ? '' : $date2[2] . '-' . $date2[0] . '-' . $date2[1];
                        ?>

                        <li>Posted <strong> <?php echo $date[0]; ?> </strong> | Expiries
                            <strong> <?php echo $date2; ?> </strong></li>

                    </div>
                    <div class="col-lg-5 " style="margin-top:10px;"><br>
                        <?php if ($single['coupons_images'] != "") { ?>
                            <img src="img/<?php echo $single['coupons_images']; ?>" class="img-responsive">
                        <?php } ?>
                    </div>
                    <div class="col-lg-1"></div>
                    <div class="col-lg-1"></div>
                    <form action="#" onsubmit="showAddress(this.address.value); return false">
                        <input type="hidden" size="34" name="address"
                               value="<?php echo $single['state'] . ',' . $single['country']; ?>"/>

                        <div class="col-lg-6"><br>
                            <?php if ($single['youtube'] != '') { ?>
                                <p style="margin-left:30px;"><span class="glyphicon glyphicon-globe"
                                                                   style="margin-right:10px;"></span>Youtube:&nbsp;<a
                                        href="<?php echo $single['youtube']; ?>"><?php echo $single['youtube']; ?></a>
                                </p>
                            <?php } ?>
                            <p style="margin-left:30px;"><span class="glyphicon glyphicon-globe"
                                                               style="margin-right:10px;"></span>Website:&nbsp;<a
                                    href="<?php echo $single['websitelink']; ?>"><?php echo $single['websitelink']; ?></a>
                            </p>
                            <?php if ($single['share_phone'] == 1) { ?><p style="margin-left:30px;"><span
                                    class="glyphicon glyphicon-phone-alt" style="margin-right:10px;"></span>Phone:&nbsp;<a
                                    href="skype:skype_user?call"><?php echo $countryCode; ?><?php echo $single['city_your'] ?></a>
                                </p><?php } ?>
                            <?php if ($single['share_email'] == 1) { ?><p style="margin-left:30px;"><span
                                    class="glyphicon glyphicon-envelope"
                                    style="margin-right:10px;"></span>Email:&nbsp;<a
                                    href="mailto:<?php echo $single['postalcode_your']; ?>"><?php echo $single['postalcode_your']; ?></a>
                                </p><?php } ?>
                            <p style="margin-left:30px;"><span class="glyphicon glyphicon-home"
                                                               style="margin-right:10px;"></span>Location:&nbsp;<?php echo $single['state'] . ',' . $single['country']; ?>
                            </p>
                    ...
                    <link rel="stylesheet" href="prettybox/css/prettyPhoto.css" type="text/css" media="screen"
                    ...
                    <div class="col-lg-12 desc_cont">
                        <p style="width: 100%;word-wrap: break-word;">
                            <b>Description: </b><?php echo html_entity_decode($single['description']); ?></p>
                        <?php $data_images = getPostImages($_REQUEST['id'], 'coupons');
                        if (count($data_images)) { ?>
                            <div class="slider1">

                                <?php foreach ($data_images as $data_image) {
//print_r($data_image);?>
                                    <div class="slide"><a href="img/<?php echo $data_image; ?>"
                                                          rel="prettyPhoto[gallery1]" title=""><img
                                                src="img/<?php echo $data_image; ?>"></a></div>
                                <?php } ?>
                            </div>
                            <script>
                                ...
                                j(document).ready(function () {
                                    ...
                                    j(".slider1:first a[rel^='prettyPhoto']").prettyPhoto({
                                        animation_speed: 'normal',
                                        theme: 'light_square',
                                        slideshow: 3000,
                                        autoplay_slideshow: false
                                    });
                                    j(".slider1:gt(0) a[rel^='prettyPhoto']").prettyPhoto({
                        ...
                        <?php } ?>
                        <div class="getadscon">
                            <p style="margin-left:40px;"><a href="https://www.facebook.com/sharer/sharer.php?u="
                                                            target="_blank">
                                    <button type="button" class="btn btn-warning btn-sm" style=" color:#fff"><i
                                            class="fa fa-facebook"></i>&nbsp;Share
                                    </button>
                                </a>&nbsp;&nbsp;<a href="https://twitter.com/share?url=" target="_blank">
                                    <button type="button" class="btn btn-warning btn-sm" style="color:#fff"><i
                                            class="fa fa-twitter"></i>&nbsp;Tweet
                                    </button>
                                </a>&nbsp;&nbsp;<a href="https://plus.google.com/share?url=" target="_blank">
                                    <button type="button" class="btn btn-warning btn-sm" style=" color:#fff"><i
                                            class="fa fa-google-plus"></i>&nbsp;Share
                                    </button>
                                </a>&nbsp;&nbsp;<a
                                    href="https://mail.google.com/mail/u/0/?view=cm&fs=1&to= &su=SUBJECT&body=BODY"
                                    target="_blank">
                                    <button type="button" class="btn btn-warning btn-sm" style="color:#fff"><i
                        ...
                        <div class="col-lg-12 getadscon">
                            ...
                            <iframe width="100%" height="500" class="gmap" frameborder="0" scrolling="no"
                                    marginheight="0" marginwidth="0"
                                    src="https://maps.google.com/maps?f=q&amp;source=s_q&amp;hl=en&amp;geocode=&amp;q=<?php echo $single['state'] . ',' . $single['country']; ?>&amp;z=7&amp;iwloc=A&amp;output=embed&amp;iwloc=near"></iframe>
                        </div>
                        <div class="col-lg-12 getadscon">
                            ...
                            <div class="col-lg-12 getadscon"><?php
                                ...
                                while ($top = mysql_fetch_array($top_query)) {
                                    ...
                                    <div class="content2" style="margin-top:10px;">
                                        <img src="img/<?php echo get_post_image($top->id, 'coupons'); ?>"
                                             class="img-responsive">
                                        <a href="getcoupons.php?id=<?php echo $top['id']; ?>">
                                            <h3><?php echo get_post_tile_string($top['coupon']); ?></h3>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <p style="margin-left:-15px; margin-top:20px;">
                                        <button type="button" class="btn btn-sm btn-success btn1">Choose File</button>
                                        &nbsp;&nbsp;No file Choosen. Maximum 1MB
                                    </p>
                                </div>

                                <div class="col-lg-12">
                                    <p style="margin-left:-15px; margin-top:10px;"><input type="checkbox"
                                                                                          style="margin-right:10px;">Send
                                        me a copy of email</p>
                                    <button type="submit" class="btn btn-lg btn-success btn1"
                                            style="margin-left:-15px; margin-top:20px; ">Send Email
                                    </button>
                                    <p style="margin-left:-15px; margin-top:10px;">Filters Email for security
                                        Reasons</p>

                                    <p style="margin-left:-15px; margin-top:10px;">By checking on "Send Email".<span
                                            style="font-size:16px;">You are Agreeing with our terms and conditions.</span>
                                    </p>
                                </div>
                            </div>
                        </div>
