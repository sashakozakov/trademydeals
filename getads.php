...
count_post_views($page,$id);
                   $single_query=mysql_query("SELECT * FROM `ads` WHERE `id`='$id' ");
    	...
    	<div class="container">
        	<div class="col-lg-12">
                	...
                	<div class="col-lg-9 ads">
                    	...
                    	<div class="col-lg-12">
                    	<h4 style="color:#CC0000;"><?php echo $single['ads_title']; ?>
                        <a href="#"><button type="button" class="btn getbtn1 btn-danger pull-right">Contact Author</button></a></h4>
                        ...
                        <div class="col-lg-5 " style="margin-top:10px;"><br>
                        	<?php if($single['ads_images']!=""){?>
                        	<img src="img/<?php echo $single['ads_images']; ?>" class="img-responsive">
							<?php } ?>
                        </div>
                        ...
                        <div class="col-lg-6"><br>
                            ...
                            <?php } ?>
                            <p style="margin-left:30px;"><span class="glyphicon glyphicon-globe" style="margin-right:10px;"></span>Website:&nbsp;<a href="http://<?php echo $single['websitelink'];?>"><?php echo $single['websitelink']; ?></a></p>
							...
							<p style="margin-left:30px;"><span class="glyphicon glyphicon-file" style="margin-right:10px;"></span>Type:&nbsp;<?php echo $single['type'];?></p>
                            <p style="margin-left:30px;"><span class="glyphicon glyphicon-tag" style="margin-right:10px;"></span>Price:&nbsp;<?php echo $single['price'];?></p>
                        </div>
...
<link rel="stylesheet" href="prettybox/css/prettyPhoto.css" type="text/css" media="screen" title="prettyPhoto main stylesheet" charset="utf-8" />
		...
		<style type="text/css" media="screen">
			* { margin: 0; padding: 0; }
                        ...
                        <?php if($single['price'] != ''){ ?>
                        	<p style="width: 100%;"><b>Price: </b><?php echo $single['price']; ?></p>
                        <?php } ?>
                        <p style="width: 100%;word-wrap: break-word;"><b>Description: </b><?php echo html_entity_decode($single['description']); ?></p>
						<?php $data_images = getPostImages($_REQUEST['id'],'ads'); if(count($data_images)){?>
<div class="slider1">
...
<?php } ?>
                        ...
                        <div class="col-lg-12 getadscon js-google-map">
                        	<div class="sub1" style="background:#3399FF; border:#3399ff solid 1px; border-radius:0px;">
							 ...
							 <iframe width="50%" height="200" class="gmap" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?f=q&amp;source=s_q&amp;hl=en&amp;geocode=&amp;q=<?php echo $single['state'].','.$single['country'];?>&amp;z=7&amp;iwloc=A&amp;output=embed&amp;iwloc=near"></iframe>
                        </div>
                    ...
                    <div class="col-lg-12 getadscon" >
                        <?php $top_query = mysql_query("SELECT * FROM `ads` where payment_status = '1' ORDER BY id DESC LIMIT 3");
                        while ($top = mysql_fetch_array($top_query)) { ?>
                             <div class="col-lg-4">
                                <div class="content2" style="margin-top:10px;">
                                    ...
                                    <a href="getads.php?id=<?php echo $top['id']; ?>">
                                        <h3><?php echo get_post_tile_string($top['ads_title']);?></h3>
                    ...
                    <div class="getads1 modal-demo" id="modal">
                     <form action="process1.php" method="post" name="request" id="request" enctype="multipart/form-data" onsubmit="return checkform();">
					 	<input type="hidden" name="to_email" id="to_email" value="<?php echo $single['postalcode_your'] ?>" />
                        <input type="hidden" name="option" id="option" value="ads" />
                        <input type="hidden" name="id" id="id" value="<?php echo $_GET['id']; ?>" />
                            ...
                            <div class="col-lg-12">
                                ...
                                <h4 class="title">Email Author</h4>
                                 <div class="col-lg-12">
                                    <div class="col-lg-8" style="margin-left:-30px; margin-top:20px;">
                                        <label class="lbl">Name:<i style="margin-left:10px; color:#CC0000;">*</i></label>
                                        <input type="text" name="name1" id="name1" class="form-control"  value="" style="background:#efefef;">
                                    </div>
                                    <div class="col-lg-8" style="margin-left:-30px; margin-top:20px;">
                                        <label class="lbl">Email:<i style="margin-left:10px; color:#CC0000;">*</i></label>
                                        <input type="text" name="email1" id="email1" class="form-control"  value="" style="background:#efefef;">
                                    </div>
                                     <div class="col-lg-10" style="margin-left:-30px; margin-top:20px;">
                                        <label class="lbl">Description:<i style="margin-left:10px; color:#CC0000;">*</i></label>
                                        <textarea name="message" class="form-control" id="message" style="background:#fff;"></textarea>
                                    </div>
                                    ...
                                    <div class="col-lg-10" style="margin-left:-30px; margin-top:20px;">
                                        <input type="checkbox" name="ccmail" style="margin-right:10px;" value="1">Send me a copy of email
                                    </div>
