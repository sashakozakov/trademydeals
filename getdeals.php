    	...
    	<div class="container">
        	<div class="col-lg-12">
                	...
                	<div class="col-lg-9 ads">
                        ...
                        <a href="<?php echo $single['websitelink']; ?>" target="_blank"><button type="button" class="btn btn-danger pull-right">Get Deal&nbsp;&nbsp;<span class="glyphicon glyphicon-chevron-right"></span></button></a></h4>
                        ...
                        <div class="col-lg-5 " style="margin-top:10px;"><br>
                        	<?php if($single['deals_images']!=""){?>	
                        	<img src="img/<?php echo $single['deals_images']; ?>" class="img-responsive">
							<?php } ?>
                        </div>
                        ...
                        <div class="col-lg-6"><br>
                            ...
                            <?php if($single['share_email'] == 1){ ?><p style="margin-left:30px;"><span class="glyphicon glyphicon-envelope" style="margin-right:10px;"></span><a href="mailto:<?php echo $single['postalcode_your'];?>">Email:&nbsp;<?php echo $single['postalcode_your']; ?></a></p><?php } ?>
...
<?php $data_images = getPostImages($_REQUEST['id'],'deals'); if(count($data_images)){?>	
<div class="slider1">
