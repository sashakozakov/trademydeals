    	...
    	<div class="container">
        	<div class="col-lg-12">
                	...
                	<div class="col-lg-9 ads">
                    	<h4 style="color:#CC0000;">Job Name
                        <button type="button" class="btn  btn-danger pull-right">Contact Author</button></h4>
                        ...
                        <div class="col-lg-12" style="background:#f4fcdd; margin-top:20px;">
                    ...
                    <div class="col-lg-12 content3" >
                    	<div class="col-lg-1">
                        	<img src="images/flower.png" style="margin-left:-45px;">
                        </div>
                        <div class="col-lg-11  ">
                        	 <a><h3>Job Name</h3></a>
                                        <p>Dropdowns are automatically positioned via CSS within the normal flow of the document. This means dropdowns may be cropped by parents with certain overflow properties or appear out of bounds of the viewport.</p>
