...
$(document).ready(function(){
 $(".deals_work5").hide();
  ...
  <body>
    ...
    <div class="logo">
        ...
        <div class="col-lg-12">
            ...
            <div class="col-lg-3">
                <div class="col-lg-12">
                    <div class="col-lg-6">
                        <button type="button" class="btn btn-sm btn-success btn1">Post Resume Free</button>
                    </div>
                    <div class="col-lg-6">
                        <button type="button" class="btn btn-sm btn-success btn2">Post Resume</button>
                    </div>
                </div>
                <div class="col-lg-12">
       ...
       <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
              <li><a href="index.php">Home</a></li>
               <li class="dropdown">
	            <a href="deals.php" class="dropdown-toggle"  data-hover="dropdown">Deals <b class="caret"></b></a>
		            ...
		            <div class="row">
			            ...
			            <div class="col-sm-3">
				             <ul class="multi-column-dropdown">
                               ...
                               <li class="divider"></li>
					            ...
					            <li><a href="#">Banking & investing</a></li>
					            <li><a href="#">Credit Cards</a></li>
					            <li><a href="#">Financial Tools</a></li>
                                 <li><a href="#">Insurance</a></li>
					            <li><a href="#">Mort gages & Loans</a></li>
					            <li><a href="#">Other</a></li>
				            </ul>
			            </div>
                         <div class="col-sm-3">
			            ...
			            <div class="col-sm-3">
				            <ul class="multi-column-dropdown">
					            ...
					            <li><a href="#">Vacations & Cruises</a></li>
                                <li><a href="#">Other</a></li>
				            </ul>
			            </div>
		            </div>
               ...
               <li class="dropdown">
	            ...
	            <a href="ads.php" class="dropdown-toggle"  data-hover="dropdown">Ads <b class="caret"></b></a>
		            ...
		            <div class="row">
			            ...
			            <div class="col-sm-2">
				            <ul class="multi-column-dropdown">
					            ...
					            <li><a href="#">animal,pet&nbsp;Service</a></li>
					            <li><a href="#">bird&nbsp;for&nbsp;sale</a></li>
					            <li><a href="#">livestock&nbsp;for&nbsp;sale</a></li>
                                 <li><a href="#">lost&nbsp;found</a></li>
					            <li><a href="#">other&nbsp;pet&nbsp;for&nbsp;sale</a></li>
					            <li><a href="#">to&nbsp;give&nbsp;or&nbsp;donate</a></li>
					            <li><a href="#">Other</a></li>
				            </ul>
			            </div>
                         <div class="col-sm-2">
                        ...
                        <div class="col-sm-2">
				            <ul class="multi-column-dropdown">
					            ...
					            <li><a href="#">Activities,groups</a></li>
					            <li><a href="#">artists,musicians</a></li>
					            <li><a href="#">Classes,lessons</a></li>
					            <li><a href="#">discussions</a></li>
                                <li><a href="#">events</a></li>
					            <li><a href="#">friendship,networking</a></li>
					            <li><a href="#">long&nbsp;lost&nbsp;relationships</a></li>
					            <li><a href="#">lost&found </a></li>
              ...
              <li  class="active"><a href="resumes.php">Resumes</a></li>   
    ...
    <form action="resumes_process.php" method="post" enctype="multipart/form-data">
    <div class="content">
        <div class="container">
            <div class="col-lg-12">
                <div class="col-lg-9">
                        ...
                        <div class="deals_form">
                            <div class="col-lg-12">
                                ...
                                <div class="col-lg-7">
                                 ...
                                 <div class="col-lg-1">
                                <input type="checkbox" class="form-control" style="height:20px;margin-left:-20px;">
                                </div>
                                <div class="col-lg-1">
                                <p style="margin-left:-30px; margin-top:5px;">Urgent&nbsp;resume $50</p>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12" style="margin-top:20px;">
                                <div class="col-lg-3">
                                    <p>Description<i style="margin-left:10px; color:#CC0000;">*</i></p>
                                </div>
                                <div class="col-lg-8">
                ...
                <div class="col-lg-3">
                    <img src="images/sony.png" class="img-responsive" style="margin-top:15px; ">
                    ...
                    <div class="deals_content">
                        ...
                        <div class="deals_form">
                            ...
                            <div class="col-lg-12" style="margin-top:20px;">
                                ...
                                <div class="col-lg-7">
                                     <input type="text" name="city_resume" class="form-control">
                                </div>
                                <div class="col-lg-2">
                                </div>
                            </div>
                            <div class="col-lg-12" style="margin-top:20px;">
                                ...
                                <div class="col-lg-7">
                                     <input type="text" name="postal_resume" class="form-control">
                                </div>
                                <div class="col-lg-2">
                                </div>
                            </div>
                    ...
                    <div class="deals_content">
                        ...
                        <div class="deals_form">
                            ...
                            <div class="col-lg-12" style="margin-top:20px;">
                                ...
                                <div class="col-lg-7">
                                     <input type="text" name="city_your" class="form-control">
                                </div>
                                <div class="col-lg-2">
                                </div>
                            </div>
                            <div class="col-lg-12" style="margin-top:20px;">
                                ...
                                <div class="col-lg-7">
                                     <input type="text" name="postal_your" class="form-control">
                                </div>
                                <div class="col-lg-2">
                                </div>
                            </div>
                ...
                <div class="col-lg-9">
                    <div class="deals_content">
                        ...
                        <div class="deals_form">
                            ...
                            <div class="deals_click111"> <br>
                            <div class="col-lg-12" style="margin-top:10px;">
                                <div class="col-lg-3">
                                    <p>images<i style="margin-left:10px; color:#CC0000;">*</i></p>
                                </div>
                                <div class="col-lg-2">
                 ...
                 <div class="col-lg-9">
                    <div class="deals_content">
                        ...
                        <div class="deals_form">
                            ...
                            <div class="col-lg-12">
                                <div class="col-lg-1">
                                    <input type="radio" name="text" value="$20"/>
                                </div>
                                <div class="col-lg-7">
                                <p style="background:#f79e12; padding:5px; margin-left:-20px; margin-top:5px;">Regular - $20permonth(post will be on Resume page)</p>
                                </div>
                                <div class="col-lg-4"></div>
                            </div>  
                             <div class="col-lg-12">
                                <div class="col-lg-1" >
                                    <input type="radio" name="text" value="$60"/>
                                </div>
                                <div class="col-lg-7">
                             ...
                             <div class="col-lg-12">
                                <div class="col-lg-1">
                                    <input type="radio"  name="text" value="$80"/>
                                </div>
                                <div class="col-lg-5">
                 ...
                 <div class="col-lg-9">
                    <div class="deals_content">
                        ...
                        <div class="deals_form">
                            ...
                            <div class="col-lg-12">
                                <div class="col-lg-1">
                                    <input type="radio" name="promote_resume" id="click2"  value="high">
                                </div>
                                <div class="col-lg-5">
                               <p style="background:#f79e12; padding:5px; margin-left:-20px; margin-top:5px;">Highlighted Resume</p>
                                </div>
                                <div class="col-lg-6"></div>
                            </div>  
                            <div class="deals_work2">
                             <div class="col-lg-12">
                                ...
                                <div class="col-lg-1">
                                    <input type="radio" name="high" value="high_regular">
                                </div>
                                <div class="col-lg-2">
                                <p style=" margin-left:-20px; margin-top:5px;">$5 Per </p>
                                </div>
                                <div class="col-lg-2">
                                  <select><option name="high_regular" value="7 Days">7 Days</option></select>                               </div>
                                <div class="col-lg-1">
                                    <p>= $35</p>
                                </div>
                                <div class="col-lg-3"></div>
                            ...
                            <div class="col-lg-12">
                                <div class="col-lg-1"></div>
                                <div class="col-lg-1">
                                    <input type="radio" name="high" value="high_member">
                                </div>
                                <div class="col-lg-2">
                            ...
                            <div class="col-lg-12">
                                ...
                                <p style=" margin-top:10px;">You'll have 5 highlited Resume inclueded+more</p>
                                ...
                                <div class="col-lg-3">
                                 <p style=" margin-left:-20px; margin-top:10px;">You'll have 10 highlited Resume inclueded+ a lot more</p>
                                 <button type="button" class="btn btn-sm btn-warning pull-right" style="margin-bottom:20px;">Read More</button>
                                </div>
                                <div class="col-lg-5">
                             ...
                             <div class="col-lg-12">
                                <div class="col-lg-1">
                                    <input type="radio" name="promote_resume" id="click3"  value="top">
                                </div>
                                <div class="col-lg-5">
                                <p style="background:#f79e12; padding:5px; margin-left:-20px; margin-top:5px;">Top Resume</p>
                                </div>
                                <div class="col-lg-6"></div>
                            </div>  
                            <div class="deals_work3">
                             <div class="col-lg-12">
                                <div class="col-lg-1"></div>
                                <div class="col-lg-1">
                                    <input type="radio" name="top" value="top_regular" />
                                </div>
                                <div class="col-lg-2">
                                <p style=" margin-left:-20px; margin-top:5px;">$8</p>
                                </div>
                                <div class="col-lg-2">
                                  <select><option value="7days">7days</option></select>
                                </div>
                                <div class="col-lg-1">
                                    <p>= $56</p>
                                </div>
                            ...
                            <div class="col-lg-12">
                                <div class="col-lg-1"></div>
                                <div class="col-lg-1">
                                    <input type="radio" name="top" value="top_member" />
                                </div>
                                <div class="col-lg-2">
                                <p style=" margin-left:-20px; margin-top:5px;">Become a member:</p>
                                </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <p style=" margin-top:10px;">You'll have 3 top Resume inclueded+more</p>
                                    <button type="button" class="btn btn-sm btn-warning pull-right" style="margin-bottom:20px;">Read More</button>
                                </div>
                                <div class="col-lg-1">
                                ...
                                <div class="col-lg-3">
                                 <p style=" margin-left:-20px; margin-top:10px;">You'll have 6 top Resume inclueded+ a lot more</p>
                                 <button type="button" class="btn btn-sm btn-warning pull-right" style="margin-bottom:20px;">Read More</button>
                                </div>
                                <div class="col-lg-5">
                             ...
                             <div class="col-lg-12">
                                <div class="col-lg-1">
                                    <input type="radio" name="promote_resume" id="click4" value="sidebar">
                                </div>
                                <div class="col-lg-5">
                            ...
                            <div class="deals_work4">
                             <div class="col-lg-12">
                                <div class="col-lg-1"></div>
                                <div class="col-lg-1">
                                    <input type="radio" name="sidebar" value="sidebar_regular" />
                                </div>
                                <div class="col-lg-2">
                                <p style=" margin-left:-20px; margin-top:5px;">$10</p>
                                </div>
                                <div class="col-lg-2">
                                  <select><option value="7days">7days</option></select>
                                </div>
                            ...
                            <div class="col-lg-12">
                                <div class="col-lg-1"></div>
                                <div class="col-lg-1">
                                    <input type="radio" name="sidebar" value="sidebar_member"/>
                                </div>
                                <div class="col-lg-2">
                                <p style=" margin-left:-20px; margin-top:5px;">Become a member:</p>
                                </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <p style=" margin-top:10px;">You'll have 2 sidebar Resume inclueded+ a lot more</p>
                                    <button type="button" class="btn btn-sm btn-warning pull-right" style="margin-bottom:20px;">Read More</button>
                                </div>
                                <div class="col-lg-1">
                                ...
                                <div class="col-lg-3">
                                 <p style=" margin-left:-20px; margin-top:10px;">You'll have 4 sidebar Resume inclueded+ a lot more</p>
                                 <button type="button" class="btn btn-sm btn-warning pull-right" style="margin-bottom:20px;">Read More</button>
                                </div>
                                <div class="col-lg-5">
                            ...
                            <div class="col-lg-12">
                                <div class="col-lg-1">
                                    <input type="radio" name="promote_resume" id="click5" value="slider">
                                </div>
                                <div class="col-lg-5">
                                <p style="background:#f79e12; padding:5px; margin-left:-20px;margin-top:5px;">Home Page Slider Resume</p>
                                </div>
                                <div class="col-lg-6"></div>
                            </div> 
                            <div class="deals_work5">
                             <div class="col-lg-12">
                                <div class="col-lg-1"></div>
                                <div class="col-lg-1">
                                    <input type="radio" name="slider" value="slider_regular"/>
                                </div>
                                <div class="col-lg-2">
                            ...
                            <div class="col-lg-12">
                                <div class="col-lg-1"></div>
                                <div class="col-lg-1">
                                    <input type="radio" name="slider" value="slider_member"/>
                                </div>
                                <div class="col-lg-2">
                                <p style=" margin-left:-20px; margin-top:5px;">Become a member:</p>
                                </div>
                            ...
                            <div class="col-lg-12">
                                ...
                                <p style=" margin-top:10px;">You'll have 1 home page Resume inclueded+more</p>
                                    <button type="button" class="btn btn-sm btn-warning pull-right" style="margin-bottom:20px;">Read More</button>
                                </div>
                                <div class="col-lg-1">
                                ...
                                <div class="col-lg-3">
                                 <p style=" margin-left:-20px; margin-top:10px;">You'll have 2 home page Resume inclueded+ a lot more</p>
                                 <button type="button" class="btn btn-sm btn-warning pull-right" style="margin-bottom:20px;">Read More</button>
                                </div>
                                <div class="col-lg-5">
                             ...
                             <p style="font-size:20px; font-weight:700; margin-left:10px;">Total Price:&nbsp;&nbsp;$
                                  ...
                                  <div class="col-lg-9">
                    <p  style="margin-left:30px; margin-top:30px;"> by posting this deals,you are agreeing with our terms and conditions</p>             
                    <input type="submit" class="btn btn btn-primary pull-right btn6" value="Post Your Deal"/>  
                 </div>
