...
<form action="resumes_process.php" method="post" enctype="multipart/form-data" name="listForm" >
<?php 
} 
else{ ?>
  <form action="paypal2/paypal5.php" method="post" enctype="multipart/form-data" name="listForm" id="listForm" onsubmit="return checkResume();">
<?php
}
?>
                      ...
                      <h4>Post Resume  &nbsp;&nbsp;&nbsp;</h4>
						...
						<!--<div class="col-lg-12" style="margin-top:20px;">
                                ...
                                <div class="col-lg-7">
									  ...
									  <?php //$q = "SELECT DISTINCT sub_menu_category,main_menu_id 													FROM  `tbl_sub_menu` where main_menu_id ='6' ";
//$sql=  mysql_query($q);
                     ...
                     // }
                      ?>
							...
							<div class="col-lg-12" style="margin-top:20px;margin-bottom:20px;">
                                ...
                                <div class="col-lg-7">
                                      <select id="sub-category" name="sub-category"><?php $q = "SELECT DISTINCT sub_menu_category_item,sub_menu_id 
                          ...
                          <div class="col-lg-12">
                                ...
                                <div class="col-lg-7">
                                      ...
                                      <input type="hidden" name="action" value="process" />
                                       ...
                                       <input name="product" id="post_type" type="hidden" value="<?php echo "resumes"; ?>">
...
$(".click6").change(function(){
  ...
  $(".click10").change(function(){
  var user_id=$("#user_id").val();
  var user_value1=$(".click10").val();
  if($(this).is(":checked")) {
  $.ajax({
    url: "display_process5.php",
    type:"POST",
...
if ($static['status']=='Pro Membership' OR $static['status']=='Gold Membership') {
                            ...
                            <div class="col-lg-12">
                                <div class="col-lg-1">      <input type="radio" class="click10 abc" name="sidebar" value="2.5">
...
if ($static['status']=='Pro Membership' )
    ...
    <div class="col-lg-12">
                                <div class="col-lg-1">
                                    <input type="checkbox" class="click10" name="promote10" value="urgent" onClick="showIPAddress(this);subtotal10()">
                                </div>
                                <div class="col-lg-5">
                                <p onclick="$('.click10').click()" style="background:#f79e12; padding:5px; margin-left:-20px;margin-top:5px;">Urgent Resume</p>
                                </div>
...
if ($static['status']=='Pro Membership' )
                 ...
                 <div class="col-lg-12">
                  <p  style="margin-left:30px; margin-top:30px;"> By posting this Resume,you are agreeing with our <a href="#"> terms and conditions </a></p>                    <?php 
if ($static['status']=='Pro Membership' OR $static['status']=='Gold Membership') { } else {?> <p class="pull-right"><span style="font-weight:bold;font-family:arial;font-size:18px;">Total Price:</span>:&nbsp;$ <input type="text" name="total" value="0" style="border:none; background:#e2e2e2;"> </p><?php } ?>
                 </div>
				 <div class="col-lg-12">

 <!--input type="button" class="btn btn btn-primary pull-right btn6" id="btnPreview" value="Preview"--> 
 <input  id="div1" style="display:none;"  type="submit" class="btn btn btn-primary pull-right btn6" value="Post My Resume" />  <!--onclick="this.form.target='_blank';return true;"-->


 <input  id="div2" type="submit" class="btn btn btn-primary pull-right btn6" value="Post My Resume" onclick="listForm.action='resumes_process.php' ; return true;" >
				  ...
				  <!-- <input type="button" class="btn btn btn-primary pull-right btn6" id="btnPreview" value="Preview">
				   <input type="submit" class="btn btn btn-primary pull-right btn6" value="Post My Resume"> -->
				 </div>
                </div>
                 </form>
             <?php 
...
<script type="text/javascript">				 
	...
	$(document).ready(function(){
	 ...
	 $.ajax({
       url: 'http://trademydeals.com/resumePreview.php',
       method:'POST',
       data: formData,   
       success: function(data) {
...
<div id="dialog6" title="Deal Preview"></div>				 				 