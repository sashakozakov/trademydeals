                  ...
                  <div class="table-responsive">
                        <table class="table table-bordered">
							...
							$count = 1; 
                             ...
                             $adssql=mysql_query("SELECT * FROM `coupons` WHERE user_id='$user_id' LIMIT $limit");
                             $sn=0;
                            ...
                            <tr>
                                ...
                                <td style="padding-left:20px;"><?php echo $ads['coupon']; ?></td>
                                <td style="padding-left:20px;" width="220px">
                                    <a class="btn btn-sm btn-success btn1" href="getcoupons.php?id=<?php echo $ads['id']; ?>">View</a>  
                                    <button type="button" class="btn btn-sm btn-success btn1">Delete</button>
                                    <a class="btn btn-sm btn-success btn1" href="editcoupons.php?id=<?php echo $ads['id']; ?>">Edit</a>
<!--                                    <button type="button" class="btn btn-sm btn-success btn1">Extended</button>-->
                        ...
                        to the query string.*/ 
                        $off_sql = mysql_query ("SELECT * FROM `coupons` WHERE user_id='$user_id'") or die ("Error in query: $off_sql".mysql_error()); 
