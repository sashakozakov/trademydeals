                        ...
                        <div class="col-lg-12">
                            <div class="col-lg-9">
                                <div class="col-lg-3">
                                    ...
                                    <p><a href="myjobs.php"><button type="button" class="btn btn-lg btn-success btn2" style="margin-top:3px">My Jobs</button></a></p>
                                ...
                                <div class="col-lg-12">
                                    <div class="deals_content">
                                        ...
                                        <div class="deals_form">
                                            <div class="col-lg-12">
                                                <div class="col-lg-1">
                                                    <input id='chk1' <?php if($ads_details['promote_jobs']!=""){echo "checked='checked';";}?>  type="checkbox" class="click2" name="highlight" value="high"
                                                           onClick="subtotal()">
                                                </div>
                                                <div class="col-lg-5">
                                            ...
                                            <div class="deals_work2">
                                                <div class="col-lg-12">
                                                    ...
                                                    if ($static['status'] == 'Pro Membership' OR $static['status'] == 'Gold Membership') {
                                                        ...
                                                        <div class="col-lg-1">
                                                            <p><input type="text" name="output" value="3"
                            ...
                            <div class="col-lg-12"> <?php
                              ...
                              <div class="col-lg-4" style="border:#fff solid 1px;">
                                ...
                                <div class="col-lg-1">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="col-lg-1">
                                                    <input id='chk2' <?php if($ads_details['promote_jobs1']!=""){echo "checked='checked';";}?> type="checkbox" class=" click3" name="promote_ads1" value="top"
                                                           onClick="subtotalnew()">
                                                </div>
                                                <div class="col-lg-5">
                                            ...
                                            <div class="deals_work3">
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="col-lg-1">
                                                        <p><input type="text" name="output1" value="6"
                                                                  style="border:none; background:#e2e2e2;"></p>
                                                    </div>
                            ...
                            <div class="col-lg-12"> <?php
                              ...
                              <div class="col-lg-4" style="border:#fff solid 1px;">
                                ...
                                <div class="col-lg-1">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="col-lg-1">
                                                    <input type="checkbox" id='chk3' <?php if($ads_details['promote_jobs2']!=""){echo "checked='checked';";}?> class=" click4" name="promote_ads2" value="home"
                                            ...
                                            <div class="deals_work4">
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="col-lg-1">
                                                        <p><input type="text" name="output2" value="9"
                                                                  style="border:none; background:#e2e2e2;"></p>
                                                    </div>
                            ...
                            <div class="col-lg-12"> <?php
                              ...
                              <div class="col-lg-4" style="border:#fff solid 1px;">
                                ...
                                <div class="col-lg-1">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="col-lg-1">
                                                    <input id='chk4' <?php if($ads_details['promote_jobs3']!=""){echo "checked='checked';";}?> type="checkbox" class=" click5" name="promote_ads3" value="sidebar" onclick=" subtotalnew2();">
                                            ...
                                            <div class="deals_work5">
                                                <div class="col-lg-12">
                                                    ...
                                                    if ($static['status'] == 'Pro Membership' OR $static['status'] == 'Gold Membership') {
                                                        ...
                                                        <div class="col-lg-1">
                                                            <p>
                                                                <input type="text" name="output3" value="7.5"
                                            ...
                                            <div class="col-lg-12">
                                                <div class="col-lg-1">
                                                    <input type="checkbox" id='chk5' <?php if($ads_details['promote_jobs4']!=""){echo "checked='checked';";}?> class=" click6" name="promote_ads4" value="slider" onclick="subtotalnew3();">
                                                </div>
                                                <div class="col-lg-5">
                                                    <p style="background:#f79e12; padding:5px; margin-left:-20px;margin-top:5px;">
                                            ...
                                            <div class="deals_work6">
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="col-lg-1">
                                                        <p><input type="text" name="output4" value="10.5"
                                                                  style="border:none; background:#e2e2e2;"></p>
                                                    </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="col-lg-1">
                                                    <input id='chk6' <?php if($ads_details['promote_jobs5']!=""){echo "checked='checked';";}?> type="checkbox" class="click10" name="promote10" value="urgent"
                                                           onClick="subtotal10()">
                                                </div>
                                                <div class="col-lg-5">
